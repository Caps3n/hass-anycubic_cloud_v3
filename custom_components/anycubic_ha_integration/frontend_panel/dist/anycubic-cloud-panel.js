!function (t) {
  ...
  const et = (t, e) => {
    ...
    for (let e = 0; e < i; e++) {
      ...
      s += o === R ? i + F : h >= 0 ? (r.push(a), i.slice(0, h) + M + i.slice(h) + k + d) : i + k + (-2 === h ? e : d);
    }
  ...
  class st {
    ...
    _(t) {
      this._$AH !== Z && O(this._$AH) ? this._$AA.nextSibling.data = t : this.T(B.createTextNode(t)), this._$AH = t;
    }
    $(t) {
      const {
          values: e,
  ...
  const oe = {
    ...
    ue = {
      ...
      B: function (t, e, i) {
        const r = t.getHours();
        let n;
        switch (n = r >= 17 ? de : r >= 12 ? ce : r >= 4 ? he : pe, e) {
          case "B":
          case "BB":
          case "BBB":
            return i.dayPeriod(n, {
  ...
  function Te(t, e, i) {
    ...
    return l.map(r => {
      ...
      return (0, ue[s[0]])(a, s, n.localize, h);
    }).join("");
  }
  function Ce(t) {
    const e = t.match($e);
  ...
  const Oe = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, Me), Ie), Fe), Be), Ne);
  var Le, Ue;
  !function (t) {
  ...
  function je(t, e) {
    const i = t.translation_key;
    return void 0 !== i && (i === e || Re[e] === i);
  }
  function Ge(t, e) {
  ...
  function Ze(t, e, i) {
    for (const r in t) {
      const n = t[r];
      if (r.split(".")[0] === e && je(n, i)) return n;
    }
    for (const r in t) {
      const n = t[r],
        s = r.split("."),
  ...
  function Je(t, e, i, r) {
    for (const e in t) {
      const n = t[e];
      if (e.split(".")[0] === i && je(n, r)) return n;
    }
  ...
  function ti(t) {
    const e = Object.keys(t).map(t => t.split(".")[1]).filter(Boolean);
    if (e.length >= 2) {
      let t = e[0];
      for (const i of e.slice(1)) {
        let e = 0;
        for (; e < t.length && e < i.length && t[e] === i[e];) e++;
        if (t = t.slice(0, e), !t) break;
      }
  ...
  function ei(t, e, i, r) {
    return function (t, e, i, r, n = "unavailable", s = {}) {
      return We(t, Je(e, i, "button", r)) || Ve({
        state: String(n),
        attributes: s
      });
    }(t, e, i, r, "unavailable", {
  ...
  function ri(t, e, i, r) {
    const n = We(t, Je(e, i, "image", r));
    return n ? function (t) {
      const e = t.attributes.access_token;
      return `${window.location.origin}/api/image_proxy/${t.entity_id}?token=${e}`;
    }(n) : void 0;
  }
  function ni(t, e, i, r, n = "unavailable", s = {}) {
    return We(t, Je(e, i, "sensor", r)) || Ve({
      state: String(n),
      attributes: s
    });
  }
  function si(t, e, i, r) {
    const n = Je(e, i, "sensor", r);
  ...
  function oi(t, e, i, r, n, s, o = void 0) {
    const a = Je(e, i, "binary_sensor", r);
    return a ? qe(t, a, n, s) : o;
  }
  function ai(t, e, i, r) {
    const n = Je(e, i, "update", r);
    return n ? qe(t, n, "Update Available", "Up To Date") : void 0;
  }
  function li(t, e, i) {
    return "Filament" === ni(t, e, i, "current_status").attributes.material_type;
  }
  function hi(t) {
  ...
  function yi() {
    return [...vi(), Oe.HotendCurrent, Oe.BedCurrent, Oe.HotendTarget, Oe.BedTarget, Oe.PrinterOnline, Oe.Availability, Oe.ProjectName, Oe.CurrentLayer];
  }
  function _i(t) {
    var e;
  ...
  let xi = class extends ut {
    willUpdate(t) {
      super.willUpdate(t), t.has("selectedPrinterID") && (this.printerEntities = Ke(this.hass, this.selectedPrinterID));
    }
    render() {
      return q`
  ...
  n([yt()], xi.prototype, "hass", void 0), n([yt()], xi.prototype, "language", void 0), n([yt({
    type: Boolean,
    reflect: !0
  })], xi.prototype, "narrow", void 0), n([yt()], xi.prototype, "route", void 0), n([yt()], xi.prototype, "panel", void 0), n([yt()], xi.prototype, "printers", void 0), n([yt({
    attribute: "selected-printer-id"
  })], xi.prototype, "selectedPrinterID", void 0), n([yt({
    attribute: "selected-printer-device"
  })], xi.prototype, "selectedPrinterDevice", void 0), n([_t()], xi.prototype, "printerEntities", void 0), xi = n([bt("anycubic-view-debug")], xi);
  var wi,
    Ei,
    Si,
    $i = "Anycubic Cloud",
  ...
  function Di(t) {
    return t.type === Ei.literal;
  }
  function Mi(t) {
    return t.type === Ei.argument;
  }
  function ki(t) {
    return t.type === Ei.number;
  }
  function Ii(t) {
    return t.type === Ei.date;
  }
  function Fi(t) {
    return t.type === Ei.time;
  }
  function Bi(t) {
    return t.type === Ei.select;
  }
  function Ni(t) {
    return t.type === Ei.plural;
  }
  function Oi(t) {
    return t.type === Ei.pound;
  }
  function Li(t) {
    return t.type === Ei.tag;
  }
  function Ui(t) {
    return !(!t || "object" != typeof t || t.type !== Si.number);
  }
  function zi(t) {
    return !(!t || "object" != typeof t || t.type !== Si.dateTime);
  }
  !function (t) {
  ...
  function Gi(t) {
    var e = {};
    return t.replace(ji, function (t) {
      var i = t.length;
      switch (t[0]) {
        case "G":
  ...
  function Ki(t) {
    var e = {};
    return "r" === t[t.length - 1] ? e.roundingPriority = "morePrecision" : "s" === t[t.length - 1] && (e.roundingPriority = "lessPrecision"), t.replace(Wi, function (t, i, r) {
  ...
  function Qi(t) {
    ...
    if ("E" === t[0] && "E" === t[1] ? (e = {
      ...
      var i = t.slice(0, 2);
      if ("+!" === i ? (e.signDisplay = "always", t = t.slice(2)) : "+?" === i && (e.signDisplay = "exceptZero", t = t.slice(2)), !qi.test(t)) throw new Error("Malformed concise eng/scientific notation");
    ...
    for (var e = {}, i = 0, n = t; i < n.length; i++) {
      ...
      switch (s.stem) {
        ...
        case "integer-width":
          ...
          s.options[0].replace(Xi, function (t, i, r, n, s, o) {
      ...
      if (qi.test(s.stem)) e.minimumIntegerDigits = s.stem.length;else if (Yi.test(s.stem)) {
        if (s.options.length > 1) throw new RangeError("Fraction-precision stems only accept a single optional option");
        s.stem.replace(Yi, function (t, i, r, n, s, o) {
      ...
      } else if (Wi.test(s.stem)) e = r(r({}, e), Ki(s.stem));else {
        var a = Zi(s.stem);
        a && (e = r(r({}, e), a));
        var l = Qi(s.stem);
        l && (e = r(r({}, e), l));
  ...
  function rr(t) {
    ...
    var i,
      r = t.language;
    return "root" !== r && (i = t.maximize().region), (ir[i || ""] || ir[r || ""] || ir["".concat(r, "-001")] || ir["001"])[0];
  }
  var nr = new RegExp("^".concat(Ri.source, "*")),
    sr = new RegExp("".concat(Ri.source, "*$"));
  function or(t, e) {
    return {
      start: t,
      end: e
  ...
  var ar = !!String.prototype.startsWith && "_a".startsWith("a", 1),
    lr = !!String.fromCodePoint,
    hr = !!Object.fromEntries,
    cr = !!String.prototype.codePointAt,
    dr = !!String.prototype.trimStart,
    pr = !!String.prototype.trimEnd,
    ...
    gr = !0;
  try {
    gr = "a" === (null === (er = wr("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")) || void 0 === er ? void 0 : er[0]);
  } catch (G) {
    gr = !1;
  }
  var br,
    mr = ar ? function (t, e, i) {
      return t.startsWith(e, i);
    } : function (t, e, i) {
      return t.slice(i, i + e.length) === e;
    },
    vr = lr ? String.fromCodePoint : function () {
    ...
    yr = hr ? Object.fromEntries : function (t) {
  ...
  if (gr) {
    ...
    br = function (t, e) {
      var i;
      return Er.lastIndex = e, null !== (i = Er.exec(t)[1]) && void 0 !== i ? i : "";
    };
  } else br = function (t, e) {
    for (var i = [];;) {
      var r = _r(t, e);
      if (void 0 === r || Ar(r) || Tr(r)) break;
    ...
    return t.prototype.parse = function () {
        ...
        if (123 === n) {
          ...
          if (35 !== n || "plural" !== e && "selectordinal" !== e) {
            if (60 === n && !this.ignoreTag && 47 === this.peek()) {
              if (i) break;
              return this.error(wi.UNMATCHED_CLOSING_TAG, or(this.clonePosition(), this.clonePosition()));
            }
            if (60 === n && !this.ignoreTag && $r(this.peek() || 0)) {
            ...
            this.bump(), r.push({
              type: Ei.pound,
              location: or(o, this.clonePosition())
            });
          }
        }
      }
      ...
      if (this.bumpSpace(), this.bumpIf("/>")) return {
        val: {
          type: Ei.literal,
          value: "<".concat(r, "/>"),
          location: or(i, this.clonePosition())
        },
        err: null
      };
      if (this.bumpIf(">")) {
        ...
        if (this.bumpIf("</")) {
          if (this.isEOF() || !$r(this.char())) return this.error(wi.INVALID_TAG, or(o, this.clonePosition()));
          var a = this.clonePosition();
          return r !== this.parseTagName() ? this.error(wi.UNMATCHED_CLOSING_TAG, or(a, this.clonePosition())) : (this.bumpSpace(), this.bumpIf(">") ? {
            val: {
              type: Ei.tag,
              value: r,
              children: s,
            ...
            err: null
          } : this.error(wi.INVALID_TAG, or(o, this.clonePosition())));
        }
        return this.error(wi.UNCLOSED_TAG, or(i, this.clonePosition()));
      }
      return this.error(wi.INVALID_TAG, or(i, this.clonePosition()));
    }, t.prototype.parseTagName = function () {
      var t = this.offset();
      for (this.bump(); !this.isEOF() && Pr(this.char());) this.bump();
      ...
      return this.isEOF() || 60 !== this.char() || !this.ignoreTag && ($r(t = this.peek() || 0) || 47 === t) ? null : (this.bump(), "<");
      var t;
      ...
      return vr.apply(void 0, e);
    }, t.prototype.tryParseUnquoted = function (t, e) {
      if (this.isEOF()) return null;
      var i = this.char();
      return 60 === i || 123 === i || 35 === i && ("plural" === e || "selectordinal" === e) || 125 === i && t > 0 ? null : (this.bump(), vr(i));
    }, t.prototype.parseArgument = function (t, e) {
      var i = this.clonePosition();
      if (this.bump(), this.bumpSpace(), this.isEOF()) return this.error(wi.EXPECT_ARGUMENT_CLOSING_BRACE, or(i, this.clonePosition()));
      if (125 === this.char()) return this.bump(), this.error(wi.EMPTY_ARGUMENT, or(i, this.clonePosition()));
      var r = this.parseIdentifierIfPossible().value;
      if (!r) return this.error(wi.MALFORMED_ARGUMENT, or(i, this.clonePosition()));
      if (this.bumpSpace(), this.isEOF()) return this.error(wi.EXPECT_ARGUMENT_CLOSING_BRACE, or(i, this.clonePosition()));
      switch (this.char()) {
        case 125:
          return this.bump(), {
            val: {
        ...
        case 44:
          return this.bump(), this.bumpSpace(), this.isEOF() ? this.error(wi.EXPECT_ARGUMENT_CLOSING_BRACE, or(i, this.clonePosition())) : this.parseArgumentOptions(t, e, r, i);
        default:
          return this.error(wi.MALFORMED_ARGUMENT, or(i, this.clonePosition()));
      }
      ...
      return this.bumpTo(r), {
        value: i,
        location: or(t, this.clonePosition())
      };
      ...
      switch (a) {
        case "":
          return this.error(wi.EXPECT_ARGUMENT_TYPE, or(o, l));
        case "number":
        case "date":
        case "time":
          this.bumpSpace();
          ...
          if (this.bumpIf(",")) {
            ...
            if (0 === (g = xr(y.val)).length) return this.error(wi.EXPECT_ARGUMENT_STYLE, or(this.clonePosition(), this.clonePosition()));
            h = {
              style: g,
          ...
          var d = or(n, this.clonePosition());
          if (h && mr(null == h ? void 0 : h.style, "::", 0)) {
            var p = fr(h.style.slice(2));
            ...
            if (0 === p.length) return this.error(wi.EXPECT_DATE_TIME_SKELETON, d);
            var u = p;
            ...
            var g = {
              ...
              parsedOptions: this.shouldParseSkeletons ? Gi(u) : {}
            };
            return {
              val: {
                type: "date" === a ? Ei.date : Ei.time,
                value: i,
                location: d,
                style: g
              },
          ...
          return {
            val: {
              type: "number" === a ? Ei.number : "date" === a ? Ei.date : Ei.time,
              value: i,
              location: d,
        ...
        case "select":
          ...
          if (this.bumpSpace(), !this.bumpIf(",")) return this.error(wi.EXPECT_SELECT_ARGUMENT_OPTIONS, or(b, r({}, b)));
          this.bumpSpace();
          var m = this.parseIdentifierIfPossible(),
            v = 0;
          if ("select" !== a && "offset" === m.value) {
            if (!this.bumpIf(":")) return this.error(wi.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE, or(this.clonePosition(), this.clonePosition()));
            var y;
            if (this.bumpSpace(), (y = this.tryParseDecimalInteger(wi.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE, wi.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE)).err) return y;
        ...
        default:
          return this.error(wi.INVALID_ARGUMENT_TYPE, or(o, l));
      }
    }, t.prototype.tryParseArgumentClose = function (t) {
      return this.isEOF() || 125 !== this.char() ? this.error(wi.EXPECT_ARGUMENT_CLOSING_BRACE, or(t, this.clonePosition())) : (this.bump(), {
        val: !0,
        err: null
      });
      ...
      for (var t = 0, e = this.clonePosition(); !this.isEOF();) {
        switch (this.char()) {
          case 39:
            this.bump();
            var i = this.clonePosition();
            if (!this.bumpUntil("'")) return this.error(wi.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE, or(i, this.clonePosition()));
            this.bump();
            break;
          case 123:
            t += 1, this.bump();
      ...
      try {
        i = function (t) {
          ...
          for (var e = t.split(Vi).filter(function (t) {
              return t.length > 0;
        ...
        return this.error(wi.INVALID_NUMBER_SKELETON, e);
      }
      return {
        val: {
          type: Si.number,
      ...
      for (var n, s = !1, o = [], a = new Set(), l = r.value, h = r.location;;) {
        if (0 === l.length) {
          ...
          var d = this.tryParseDecimalInteger(wi.EXPECT_PLURAL_ARGUMENT_SELECTOR, wi.INVALID_PLURAL_ARGUMENT_SELECTOR);
          if (d.err) return d;
          h = or(c, this.clonePosition()), l = this.message.slice(c.offset, this.offset());
        }
        if (a.has(l)) return this.error("select" === e ? wi.DUPLICATE_SELECT_ARGUMENT_SELECTOR : wi.DUPLICATE_PLURAL_ARGUMENT_SELECTOR, h);
        "other" === l && (s = !0), this.bumpSpace();
        var p = this.clonePosition();
        if (!this.bumpIf("{")) return this.error("select" === e ? wi.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT : wi.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT, or(this.clonePosition(), this.clonePosition()));
      ...
      return 0 === o.length ? this.error("select" === e ? wi.EXPECT_SELECT_ARGUMENT_SELECTOR : wi.EXPECT_PLURAL_ARGUMENT_SELECTOR, or(this.clonePosition(), this.clonePosition())) : this.requiresOtherClause && !s ? this.error(wi.MISSING_OTHER_CLAUSE, or(this.clonePosition(), this.clonePosition())) : {
        val: o,
        err: null
      };
  ...
  function Cr(t) {
    t.forEach(function (t) {
      if (delete t.location, Bi(t) || Ni(t)) for (var e in t.options) delete t.options[e].location, Cr(t.options[e].value);else ki(t) && Ui(t.style) || (Ii(t) || Fi(t)) && zi(t.style) ? delete t.style.location : Li(t) && Cr(t.children);
    });
  }
  function Hr(t, e) {
    void 0 === e && (e = {}), e = r({
    ...
    var i = new Sr(t, e).parse();
    if (i.err) {
      var n = SyntaxError(wi[i.err.kind]);
      throw n.location = i.err.location, n.originalMessage = i.err.message, n;
    }
    return (null == e ? void 0 : e.captureLocation) || Cr(i.val), i.val;
  }
  function Dr(t, e) {
    var i = e && e.cache ? e.cache : Lr,
      r = e && e.serializer ? e.serializer : Br;
    return (e && e.strategy ? e.strategy : Fr)(t, {
      cache: i,
      serializer: r
    });
  }
  ...
  function Fr(t, e) {
    return Ir(t, this, 1 === t.length ? Mr : kr, e.cache.create(), e.serializer);
  }
  var Br = function () {
  ...
  var Or,
    ...
    Ur = {
      variadic: function (t, e) {
        return Ir(t, this, kr, e.cache.create(), e.serializer);
      },
      monadic: function (t, e) {
        return Ir(t, this, Mr, e.cache.create(), e.serializer);
      }
    };
  !function (t) {
  ...
  var zr,
    ...
    jr = function (t) {
      function e(e, i, r, n) {
        return t.call(this, 'Invalid values for "'.concat(e, '": "').concat(i, '". Options are "').concat(Object.keys(r).join('", "'), '"'), Or.INVALID_VALUE, n) || this;
      }
      return i(e, t), e;
    }(Rr),
    Gr = function (t) {
      function e(e, i, r) {
        return t.call(this, 'Value for "'.concat(e, '" must be of type ').concat(i), Or.INVALID_VALUE, r) || this;
      }
      return i(e, t), e;
    }(Rr),
    Vr = function (t) {
      function e(e, i) {
        return t.call(this, 'The intl string context variable "'.concat(e, '" was not provided to the string "').concat(i, '"'), Or.MISSING_VALUE, i) || this;
      }
      return i(e, t), e;
    }(Rr);
  function Yr(t) {
  ...
  function Wr(t, e, i, r, n, s, o) {
    if (1 === t.length && Di(t[0])) return [{
      type: zr.literal,
      value: t[0].value
    }];
    for (var a = [], l = 0, h = t; l < h.length; l++) {
      ...
      if (Di(c)) a.push({
        type: zr.literal,
        value: c.value
      });else if (Oi(c)) "number" == typeof s && a.push({
        type: zr.literal,
        value: i.getNumberFormat(e).format(s)
      });else {
        var d = c.value;
        if (!n || !(d in n)) throw new Vr(d, o);
        var p = n[d];
        if (Mi(c)) p && "string" != typeof p && "number" != typeof p || (p = "string" == typeof p || "number" == typeof p ? String(p) : ""), a.push({
          type: "string" == typeof p ? zr.literal : zr.object,
          value: p
        });else if (Ii(c)) {
          var u = "string" == typeof c.style ? r.date[c.style] : zi(c.style) ? c.style.parsedOptions : void 0;
          a.push({
            type: zr.literal,
            value: i.getDateTimeFormat(e, u).format(p)
          });
        } else if (Fi(c)) {
          u = "string" == typeof c.style ? r.time[c.style] : zi(c.style) ? c.style.parsedOptions : r.time.medium;
          a.push({
            type: zr.literal,
            value: i.getDateTimeFormat(e, u).format(p)
          });
        } else if (ki(c)) {
          (u = "string" == typeof c.style ? r.number[c.style] : Ui(c.style) ? c.style.parsedOptions : void 0) && u.scale && (p *= u.scale || 1), a.push({
            type: zr.literal,
          ...
          if (Li(c)) {
            var g = c.children,
              b = c.value,
              m = n[b];
            if (!Yr(m)) throw new Gr(b, "function", o);
            var v = m(Wr(g, e, i, r, n, s).map(function (t) {
              return t.value;
            }));
            Array.isArray(v) || (v = [v]), a.push.apply(a, v.map(function (t) {
              return {
                type: "string" == typeof t ? zr.literal : zr.object,
                value: t
              };
            }));
          }
          if (Bi(c)) {
            if (!(y = c.options[p] || c.options.other)) throw new jr(c.value, p, Object.keys(c.options), o);
            a.push.apply(a, Wr(y.value, e, i, r, n));
          } else if (Ni(c)) {
            var y;
            ...
            if (!y) throw new jr(c.value, p, Object.keys(c.options), o);
            a.push.apply(a, Wr(y.value, e, i, r, n, p - (c.offset || 0)));
          } else ;
        }
      }
    }
    return function (t) {
      return t.length < 2 ? t : t.reduce(function (t, e) {
        var i = t[t.length - 1];
        return i && i.type === zr.literal && e.type === zr.literal ? i.value += e.value : t.push(e), t;
      }, []);
    }(a);
  }
  function Xr(t, e) {
      ...
      function t(e, i, n, o) {
        ...
        if (void 0 === i && (i = t.defaultLocale), this.formatterCache = {
          ...
          var i = e.reduce(function (t, e) {
            return t.length && e.type === zr.literal && "string" == typeof t[t.length - 1] ? t[t.length - 1] += e.value : t.push(e.value), t;
          }, []);
          return i.length <= 1 ? i[0] || "" : i;
        }, this.formatToParts = function (t) {
          return Wr(l.ast, l.locales, l.formatters, l.formats, t, void 0, l.message);
        ...
        this.formats = Xr(t.formats, n), this.formatters = o && o.formatters || (void 0 === (a = this.formatterCache) && (a = {
          number: {},
          dateTime: {},
          pluralRules: {}
        }), {
  ...
  function Jr(t, e, ...i) {
    ...
    var n;
    try {
      n = t.split(".").reduce((t, e) => t[e], Qr[r]);
    } catch (e) {
      n = t.split(".").reduce((t, e) => t[e], Qr.en);
    }
    if (void 0 === n && (n = t.split(".").reduce((t, e) => t[e], Qr.en)), !i.length) return n;
    const s = {};
  ...
  /**
       ...
       * SPDX-License-Identifier: BSD-3-Clause
       */
  const sn = rn(class extends nn {
      constructor(t) {
        if (super(t), t.type !== tn || "class" !== t.name || t.strings?.length > 2) throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.");
      }
      render(t) {
    ...
    on = "important",
    an = " !" + on,
    ln = rn(class extends nn {
      constructor(t) {
        if (super(t), t.type !== tn || "style" !== t.name || t.strings?.length > 2) throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.");
      }
      render(t) {
      ...
      update(t, [e]) {
        ...
        for (const t in e) {
          ...
          if (null != r) {
            this.ft.add(t);
            const e = "string" == typeof r && r.endsWith(an);
    ...
    cn = () => document.createComment(""),
    dn = (t, e, i) => {
      const r = t._$AA.parentNode,
        n = void 0 === e ? t._$AB : e._$AA;
      if (void 0 === i) {
        const e = r.insertBefore(cn(), n),
          s = r.insertBefore(cn(), n);
    ...
    bn = (t, e) => {
      ...
      for (const t of i) t._$AO?.(e, !1), bn(t, e);
      return !0;
    },
    mn = t => {
      let e, i;
  ...
  /**
       ...
       */
  function yn(t) {
    void 0 !== this._$AN ? (mn(this), this._$AM = t, vn(this)) : this._$AM = t;
  }
  function _n(t, e = !1, i = 0) {
    const r = this._$AH,
      n = this._$AN;
    if (void 0 !== n && 0 !== n.size) if (e) {
      if (Array.isArray(r)) for (let t = i; t < r.length; t++) bn(r[t], !1), mn(r[t]);else null != r && (bn(r, !1), mn(r));
    } else bn(this, t);
  }
  const fn = t => {
    t.type == en && (t._$AP ??= _n, t._$AQ ??= yn);
  };
  class xn extends nn {
    constructor() {
    ...
    _$AT(t, e, i) {
      super._$AT(t, e, i), vn(this), this.isConnected = t._$AU;
    }
    _$AO(t, e = !0) {
      t !== this.isConnected && (this.isConnected = t, t ? this.reconnected?.() : this.disconnected?.()), e && (bn(this, t), mn(this));
    }
    setValue(t) {
  ...
  const Sn = new Map(),
    $n = new WeakSet(),
    Pn = () => new Promise(t => requestAnimationFrame(t)),
    An = (t, e) => {
      const i = t - e;
      return 0 === i ? void 0 : i;
    },
    ...
    Dn = ["left", "top", "width", "height", "opacity", "color", "background"],
    Mn = new WeakMap();
  const kn = rn(class extends xn {
      constructor(t) {
      ...
      update(t, [e]) {
        ...
        return i && (this.u = t.options?.host, this.u.addController(this), this.u.updateComplete.then(t => this.t = !0), this.element = t.element, Mn.set(this.element, this)), this.optionsOrCallback = e, (i || "function" != typeof e) && this.p(e), this.render(e);
      }
      p(t) {
        t = t ?? {};
        ...
        void 0 !== e && ((t = {
          ...
          ...t.keyframeOptions
        }), t.properties ??= Dn, this.options = t;
      }
      m() {
        const t = {},
      ...
      async hostUpdated() {
        ...
        if (void 0 !== this.A) {
          ...
          const i = Sn.get(this.options.inId);
          if (i) {
            Sn.delete(this.options.inId);
            const {
              from: n,
              to: s
            } = this.N(i, r, e);
      ...
      async disconnected() {
        if (!this.h) return;
        if (void 0 !== this.options.id && Sn.set(this.options.id, this.A), void 0 === this.options.out) return;
        if (this.prepare(), await Pn(), this.i?.isConnected) {
    ...
    In = t => e => "function" == typeof e ? ((t, e) => (window.customElements.get(t) || window.customElements.define(t, e), e))(t, e) : ((t, e) => {
      const {
        kind: i,
        elements: r
      } = e;
  ...
  })], Fn.prototype, "cameraEntity", void 0), n([_t()], Fn.prototype, "camImgString", void 0), Fn = n([In("anycubic-printercard-camera_view")], Fn);
  const Nn = "secondary_",
  ...
  let Rn = class extends ut {
    constructor() {
      super(...arguments), this.box_id = 0, this._runoutRefillId = On, this._spoolsEntityId = Un, this.spoolList = [], this.selectedIndex = -1, this.selectedMaterialType = "", this.selectedColor = [0, 0, 0], this._changingRunout = !1, this._openDryingModal = () => {
        ...
        this._changingRunout || (this._changingRunout = !0, this.hass.callService("switch", "toggle", {
          entity_id: Qe(this.printerEntityIdPart, "switch", this._runoutRefillId)
        }).then(() => {
    ...
    willUpdate(t) {
      var e, i, r, n;
      super.willUpdate(t), t.has("language") && (this._buttonRefill = Jr("card.buttons.runout_refill", this.language), this._buttonDry = Jr("card.buttons.dry", this.language)), t.has("box_id") && (1 === this.box_id ? (this._runoutRefillId = Ln, this._spoolsEntityId = zn) : (this._runoutRefillId = On, this._spoolsEntityId = Un)), (t.has("hass") || t.has("printerEntities") || t.has("printerEntityIdPart")) && (this.spoolList = ni(this.hass, this.printerEntities, this.printerEntityIdPart, this._spoolsEntityId, "not loaded", {
        spool_info: []
      }).attributes.spool_info, this._runoutRefillState = (e = this.hass, i = this.printerEntities, r = this.printerEntityIdPart, n = this._runoutRefillId, We(e, Je(i, r, "switch", n))));
    }
    render() {
      return q`
  ...
  })], Rn.prototype, "printerEntityIdPart", void 0), n([yt()], Rn.prototype, "box_id", void 0), n([_t()], Rn.prototype, "_runoutRefillId", void 0), n([_t()], Rn.prototype, "_spoolsEntityId", void 0), n([_t()], Rn.prototype, "spoolList", void 0), n([_t()], Rn.prototype, "selectedIndex", void 0), n([_t()], Rn.prototype, "selectedMaterialType", void 0), n([_t()], Rn.prototype, "selectedColor", void 0), n([_t()], Rn.prototype, "_runoutRefillState", void 0), n([_t()], Rn.prototype, "_buttonRefill", void 0), n([_t()], Rn.prototype, "_buttonDry", void 0), n([_t()], Rn.prototype, "_changingRunout", void 0), Rn = n([In("anycubic-printercard-multicolorbox_view")], Rn);
  class jn {
    constructor(t) {
      this.scale_factor = t;
    }
  ...
  let Xn = class extends ut {
    ...
    willUpdate(t) {
      if (super.willUpdate(t), t.has("scaleFactor") && this._onResizeEvent(), t.has("hass") || t.has("printerEntities") || t.has("printerEntityIdPart")) {
        const t = ri(this.hass, this.printerEntities, this.printerEntityIdPart, "job_preview");
        this.imagePreviewUrl !== t && (this.imagePreviewUrl = t, this.imagePreviewBgUrl = this.imagePreviewUrl ? `url('${t}')` : void 0), this._progressNum = Number(ni(this.hass, this.printerEntities, this.printerEntityIdPart, "job_progress", 0).state) / 100;
        const e = di(ni(this.hass, this.printerEntities, this.printerEntityIdPart, "job_state").state.toLowerCase());
  ...
  n([xt(".ac-printercard-animatedprinter")], Xn.prototype, "_rootElement", void 0), n([xt(".ac-apr-scalable")], Xn.prototype, "_elAcAPr_scalable", void 0), n([xt(".ac-apr-frame")], Xn.prototype, "_elAcAPr_frame", void 0), n([xt(".ac-apr-hole")], Xn.prototype, "_elAcAPr_hole", void 0), n([xt(".ac-apr-buildarea")], Xn.prototype, "_elAcAPr_buildarea", void 0), n([xt(".ac-apr-animprint")], Xn.prototype, "_elAcAPr_animprint", void 0), n([xt(".ac-apr-buildplate")], Xn.prototype, "_elAcAPr_buildplate", void 0), n([xt(".ac-apr-xaxis")], Xn.prototype, "_elAcAPr_xaxis", void 0), n([xt(".ac-apr-gantry")], Xn.prototype, "_elAcAPr_gantry", void 0), n([xt(".ac-apr-nozzle")], Xn.prototype, "_elAcAPr_nozzle", void 0), n([yt()], Xn.prototype, "hass", void 0), n([yt({
    ...
    attribute: "printer-entity-id-part"
  })], Xn.prototype, "printerEntityIdPart", void 0), n([_t()], Xn.prototype, "dimensions", void 0), n([_t()], Xn.prototype, "resizeObserver", void 0), n([_t()], Xn.prototype, "_progressNum", void 0), n([_t()], Xn.prototype, "animKeyframeGantry", void 0), n([_t()], Xn.prototype, "_isPrinting", void 0), n([_t()], Xn.prototype, "imagePreviewUrl", void 0), n([_t()], Xn.prototype, "imagePreviewBgUrl", void 0), Xn = n([In("anycubic-printercard-animated_printer")], Xn);
  ...
  n([yt()], qn.prototype, "hass", void 0), n([yt({
    ...
    attribute: "scale-factor"
  })], qn.prototype, "scaleFactor", void 0), qn = n([In("anycubic-printercard-printer_view")], qn);
  /**
       * @license
       * Copyright 2017 Google LLC
       * SPDX-License-Identifier: BSD-3-Clause
    ...
    Zn = rn(class extends nn {
      ...
      update(t, [e, i, r]) {
        ...
        let h,
          ...
          u = 0,
          g = s.length - 1;
        for (; d <= p && u <= g;) if (null === n[d]) d++;else if (null === n[p]) p--;else if (a[d] === o[u]) l[u] = pn(n[d], s[u]), d++, u++;else if (a[p] === o[g]) l[g] = pn(n[p], s[g]), p--, g--;else if (a[d] === o[g]) l[g] = pn(n[d], s[g]), dn(t, l[g + 1], n[d]), d++, g--;else if (a[p] === o[u]) l[u] = pn(n[p], s[u]), dn(t, n[d], n[p]), p--, u++;else if (void 0 === h && (h = Kn(o, u, g), c = Kn(a, d, p)), h.has(a[d])) {
          if (h.has(a[p])) {
            const e = c.get(o[u]),
              i = void 0 !== e ? n[e] : null;
            if (null === i) {
              const e = dn(t, n[d]);
              pn(e, s[u]), l[u] = e;
            } else l[u] = pn(i, s[u]), dn(t, n[d], i), n[e] = null;
            u++;
          } else gn(n[p]), p--;
        } else gn(n[d]), d++;
        for (; u <= g;) {
  ...
  n([yt({
    ...
    type: Number
  })], Qn.prototype, "progress", void 0), Qn = n([In("anycubic-printercard-progress-line")], Qn);
  ...
  n([yt({
    ...
    type: String
  })], Jn.prototype, "unit", void 0), Jn = n([In("anycubic-printercard-stat-line")], Jn);
  ...
  n([yt({
    ...
    type: String
  })], ts.prototype, "temperatureUnit", void 0), ts = n([In("anycubic-printercard-stat-temperature")], ts);
  let es = class extends ut {
    ...
    render() {
      return q`<anycubic-printercard-stat-line
      .name=${this.name}
      .value=${gi(this.currentTime, this.timeType, this.round, this.use_24hr)}
    ></anycubic-printercard-stat-line>`;
    }
    _incTime() {
  ...
  n([yt({
    ...
    type: Boolean
  })], es.prototype, "isSeconds", void 0), n([_t()], es.prototype, "currentTime", void 0), n([_t()], es.prototype, "lastIntervalId", void 0), es = n([In("anycubic-printercard-stat-time")], es);
  let is = class extends ut {
    ...
    willUpdate(t) {
      ...
      if (super.willUpdate(t), t.has("hass") || t.has("printerEntities") || t.has("printerEntityIdPart")) {
        this._entETA = ni(this.hass, this.printerEntities, this.printerEntityIdPart, "job_time_remaining"), this._entElapsed = ni(this.hass, this.printerEntities, this.printerEntityIdPart, "job_time_elapsed"), this._entRemaining = ni(this.hass, this.printerEntities, this.printerEntityIdPart, "job_time_remaining"), this._entBedCurrent = ni(this.hass, this.printerEntities, this.printerEntityIdPart, "hotbed_temperature"), this._entHotendCurrent = ni(this.hass, this.printerEntities, this.printerEntityIdPart, "nozzle_temperature"), this._entBedTarget = ni(this.hass, this.printerEntities, this.printerEntityIdPart, "target_hotbed_temperature"), this._entHotendTarget = ni(this.hass, this.printerEntities, this.printerEntityIdPart, "target_nozzle_temperature"), this._valStatus = Ye(ni(this.hass, this.printerEntities, this.printerEntityIdPart, "job_state").state), this._valOnline = oi(this.hass, this.printerEntities, this.printerEntityIdPart, "printer_online", "Online", "Offline", "unknown"), this._valAvailability = Ye(ni(this.hass, this.printerEntities, this.printerEntityIdPart, "current_status").state), this._valJobName = ni(this.hass, this.printerEntities, this.printerEntityIdPart, "job_name").state, this._valCurrentLayer = ni(this.hass, this.printerEntities, this.printerEntityIdPart, "job_current_layer").state;
        const t = ni(this.hass, this.printerEntities, this.printerEntityIdPart, "job_speed_mode", "", {
            available_modes: [],
            print_speed_mode_code: -1
          }),
          i = _i(t),
          r = null !== (e = t.attributes.print_speed_mode_code) && void 0 !== e ? e : 0;
        this._valSpeedMode = r >= 0 && r in i ? i[r] : "Unknown", this._valFanSpeed = ni(this.hass, this.printerEntities, this.printerEntityIdPart, "fan_speed", 0).state, this._valDryStatus = oi(this.hass, this.printerEntities, this.printerEntityIdPart, "drying_active", "Drying", "Not Drying", "unknown");
        const n = Number(ni(this.hass, this.printerEntities, this.printerEntityIdPart, "drying_total_duration", 0).state),
          s = Number(ni(this.hass, this.printerEntities, this.printerEntityIdPart, "drying_remaining_time", 0).state);
        this._valDryRemain = isNaN(s) ? "" : `${s} Mins`, this._valDryProgress = !isNaN(n) && n > 0 ? s / n * 100 : 0, this._valOnTime = ni(this.hass, this.printerEntities, this.printerEntityIdPart, "job_on_time", 0).state, this._valOffTime = ni(this.hass, this.printerEntities, this.printerEntityIdPart, "job_off_time", 0).state, this._valBottomTime = ni(this.hass, this.printerEntities, this.printerEntityIdPart, "job_bottom_time", 0).state, this._valModelHeight = ni(this.hass, this.printerEntities, this.printerEntityIdPart, "job_model_height", 0).state, this._valBottomLayers = ni(this.hass, this.printerEntities, this.printerEntityIdPart, "job_bottom_layers", 0).state, this._valZUpHeight = ni(this.hass, this.printerEntities, this.printerEntityIdPart, "job_z_up_height", 0).state, this._valZUpSpeed = ni(this.hass, this.printerEntities, this.printerEntityIdPart, "job_z_up_speed", 0).state, this._valZDownSpeed = ni(this.hass, this.printerEntities, this.printerEntityIdPart, "job_z_down_speed", 0).state;
      }
      (t.has("language") || t.has("monitoredStats")) && (this._statTranslations = this.monitoredStats.reduce((t, e) => (t[e] = Jr(`card.monitored_stats.${e}`, this.language), t), {}));
    }
    render() {
      return q`
    ...
    _renderStats() {
      return Zn(this.monitoredStats, t => t, (t, e) => {
        switch (t) {
          case Oe.Status:
            return q`
              <anycubic-printercard-stat-line
  ...
  })], is.prototype, "progressPercent", void 0), n([_t()], is.prototype, "_statTranslations", void 0), n([_t()], is.prototype, "_entETA", void 0), n([_t()], is.prototype, "_entElapsed", void 0), n([_t()], is.prototype, "_entRemaining", void 0), n([_t()], is.prototype, "_entBedCurrent", void 0), n([_t()], is.prototype, "_entHotendCurrent", void 0), n([_t()], is.prototype, "_entBedTarget", void 0), n([_t()], is.prototype, "_entHotendTarget", void 0), n([_t()], is.prototype, "_valStatus", void 0), n([_t()], is.prototype, "_valOnline", void 0), n([_t()], is.prototype, "_valAvailability", void 0), n([_t()], is.prototype, "_valJobName", void 0), n([_t()], is.prototype, "_valCurrentLayer", void 0), n([_t()], is.prototype, "_valSpeedMode", void 0), n([_t()], is.prototype, "_valFanSpeed", void 0), n([_t()], is.prototype, "_valDryStatus", void 0), n([_t()], is.prototype, "_valDryRemain", void 0), n([_t()], is.prototype, "_valDryProgress", void 0), n([_t()], is.prototype, "_valOnTime", void 0), n([_t()], is.prototype, "_valOffTime", void 0), n([_t()], is.prototype, "_valBottomTime", void 0), n([_t()], is.prototype, "_valModelHeight", void 0), n([_t()], is.prototype, "_valBottomLayers", void 0), n([_t()], is.prototype, "_valZUpHeight", void 0), n([_t()], is.prototype, "_valZUpSpeed", void 0), n([_t()], is.prototype, "_valZDownSpeed", void 0), is = n([In("anycubic-printercard-stats-component")], is);
  const rs = p`
  :host {
    display: none;
    position: fixed;
...
`;
  ...
  n([yt()], ns.prototype, "item", void 0), n([_t()], ns.prototype, "_isActive", void 0), ns = n([In("anycubic-ui-select-dropdown-item")], ns);
  let ss = class extends ut {
    ...
    render() {
      ...
      return this.availableOptions ? q`
          ...
          <div class="ac-ui-select-options" style=${ln(e)}>
            ${this._renderOptions()}
          </div>
        ` : Z;
    }
    _renderOptions() {
      return Bn(Object.keys(this.availableOptions), (t, e) => q`
  ...
  })], ss.prototype, "initialItem", void 0), n([_t()], ss.prototype, "_selectedItem", void 0), n([_t()], ss.prototype, "_active", void 0), n([_t()], ss.prototype, "_hidden", void 0), ss = n([In("anycubic-ui-select-dropdown")], ss);
  const os = {
      keyframeOptions: {
        duration: 250,
        direction: "alternate",
  ...
  let ys = class extends ut {
    constructor() {
      super(...arguments), this.box_id = 0, this._dryingPresetId1 = as, this._dryingPresetId2 = ls, this._dryingPresetId3 = hs, this._dryingPresetId4 = cs, this._dryingStopId = ds, this._hasDryingPreset1 = !1, this._hasDryingPreset2 = !1, this._hasDryingPreset3 = !1, this._hasDryingPreset4 = !1, this._hasDryingStop = !1, this._dryingPresetTemp1 = "", this._dryingPresetDur1 = "", this._dryingPresetTemp2 = "", this._dryingPresetDur2 = "", this._dryingPresetTemp3 = "", this._dryingPresetDur3 = "", this._dryingPresetTemp4 = "", this._dryingPresetDur4 = "", this._isOpen = !1, this._handleDryingPreset1 = () => {
    ...
    willUpdate(t) {
      if (super.willUpdate(t), t.has("language") && (this._heading = Jr("card.drying_settings.heading", this.language), this._buttonTextPreset = Jr("card.drying_settings.button_preset", this.language), this._buttonTextMinutes = Jr("card.drying_settings.button_minutes", this.language), this._buttonStopDrying = Jr("card.drying_settings.button_stop_drying", this.language)), t.has("box_id") && (1 === this.box_id ? (this._dryingPresetId1 = us, this._dryingPresetId2 = gs, this._dryingPresetId3 = bs, this._dryingPresetId4 = ms, this._dryingStopId = vs) : (this._dryingPresetId1 = as, this._dryingPresetId2 = ls, this._dryingPresetId3 = hs, this._dryingPresetId4 = cs, this._dryingStopId = ds)), t.has("hass") || t.has("selectedPrinterDevice")) {
        const t = ei(this.hass, this.printerEntities, this.printerEntityIdPart, this._dryingPresetId1);
        this._hasDryingPreset1 = ii(t), this._dryingPresetTemp1 = String(t.attributes.temperature), this._dryingPresetDur1 = String(t.attributes.duration);
        const e = ei(this.hass, this.printerEntities, this.printerEntityIdPart, this._dryingPresetId2);
        this._hasDryingPreset2 = ii(e), this._dryingPresetTemp2 = String(e.attributes.temperature), this._dryingPresetDur2 = String(e.attributes.duration);
        const i = ei(this.hass, this.printerEntities, this.printerEntityIdPart, this._dryingPresetId3);
        this._hasDryingPreset3 = ii(i), this._dryingPresetTemp3 = String(i.attributes.temperature), this._dryingPresetDur3 = String(i.attributes.duration);
        const r = ei(this.hass, this.printerEntities, this.printerEntityIdPart, this._dryingPresetId4);
        this._hasDryingPreset4 = ii(r), this._dryingPresetTemp4 = String(r.attributes.temperature), this._dryingPresetDur4 = String(r.attributes.duration);
        const n = ei(this.hass, this.printerEntities, this.printerEntityIdPart, this._dryingStopId);
        this._hasDryingStop = ii(n);
      }
    }
    update(t) {
    ...
    _pressHassButton(t) {
      this.printerEntityIdPart && this.hass.callService("button", "press", {
        entity_id: Qe(this.printerEntityIdPart, "button", t)
      }).then().catch(t => {});
    }
    static get styles() {
      return p`
  ...
  n([yt()], ys.prototype, "hass", void 0), n([yt()], ys.prototype, "language", void 0), n([yt({
    ...
    attribute: "printer-entity-id-part"
  })], ys.prototype, "printerEntityIdPart", void 0), n([_t()], ys.prototype, "box_id", void 0), n([_t()], ys.prototype, "_dryingPresetId1", void 0), n([_t()], ys.prototype, "_dryingPresetId2", void 0), n([_t()], ys.prototype, "_dryingPresetId3", void 0), n([_t()], ys.prototype, "_dryingPresetId4", void 0), n([_t()], ys.prototype, "_dryingStopId", void 0), n([_t()], ys.prototype, "_hasDryingPreset1", void 0), n([_t()], ys.prototype, "_hasDryingPreset2", void 0), n([_t()], ys.prototype, "_hasDryingPreset3", void 0), n([_t()], ys.prototype, "_hasDryingPreset4", void 0), n([_t()], ys.prototype, "_hasDryingStop", void 0), n([_t()], ys.prototype, "_dryingPresetTemp1", void 0), n([_t()], ys.prototype, "_dryingPresetDur1", void 0), n([_t()], ys.prototype, "_dryingPresetTemp2", void 0), n([_t()], ys.prototype, "_dryingPresetDur2", void 0), n([_t()], ys.prototype, "_dryingPresetTemp3", void 0), n([_t()], ys.prototype, "_dryingPresetDur3", void 0), n([_t()], ys.prototype, "_dryingPresetTemp4", void 0), n([_t()], ys.prototype, "_dryingPresetDur4", void 0), n([_t()], ys.prototype, "_isOpen", void 0), n([_t()], ys.prototype, "_heading", void 0), n([_t()], ys.prototype, "_buttonTextPreset", void 0), n([_t()], ys.prototype, "_buttonTextMinutes", void 0), n([_t()], ys.prototype, "_buttonStopDrying", void 0), ys = n([In("anycubic-printercard-multicolorbox_modal_drying")], ys);
  const _s = t => ws(255, Math.round(Number(t))),
    fs = t => _s(255 * t),
    xs = t => ws(1, t / 255),
  ...
  class $s {
    constructor(t, e, i, r) {
      return $s.isBaseConstructor(t) ? (this.r = _s(t.r), this.g = _s(t.g), this.b = _s(t.b), void 0 !== t.a && (this.a = Es(t.a)), this) : $s.parse(t, e, i, r);
    }
    static parse(t, e, i, r) {
      if ($s.isBaseConstructor(t)) return new $s(t);
      if (void 0 !== e && void 0 !== i) {
        let n = _s(t);
        return e = _s(e), i = _s(i), void 0 !== r && (r = Es(r)), new $s({
          r: n,
          g: e,
          b: i,
          a: r
    ...
    static fromHsl({
      ...
      let o = 0,
        a = 0,
        l = 0;
      return 0 <= t && t < 60 ? (o = r, a = n, l = 0) : 60 <= t && t < 120 ? (o = n, a = r, l = 0) : 120 <= t && t < 180 ? (o = 0, a = r, l = n) : 180 <= t && t < 240 ? (o = 0, a = n, l = r) : 240 <= t && t < 300 ? (o = n, a = 0, l = r) : 300 <= t && t < 360 && (o = r, a = 0, l = n), new $s({
        r: fs(s + o),
        g: fs(s + a),
        b: fs(s + l)
      });
    ...
    static fromCMYK({
      ...
      const s = t => fs(1 - Math.min(1, t / 100 * (1 - r) + r));
      return new $s({
        r: s(t),
        b: s(e),
        g: s(i),
    ...
    get rgbaHex() {
      let t = this.rgba;
      return t[3] = fs(t[3]), `#${t.map(t => t.toString(16).padStart(2, "0")).join("")}`.toUpperCase();
    }
    get hsv() {
      const t = xs(this.r),
        e = xs(this.g),
...
>
  ...
  `;
    constructor() {
      super(), this.gradient = {
        backgroundImage: `linear-gradient(90deg, ${As(24)})`
    ...
    >
      ...
      >
        <a class="slider" style=${ln(this.sliderCss(this.h))}></a>
      </lit-movable>
    </div>`;
    }
  }
...
`,
    ...
    setPreviewGradient() {
      ...
      if ("rgb" !== e || "a" === i) {
        if ("h" === i) return o = this.max = 359, void (this.previewGradient = {
          "--preview": `linear-gradient(90deg, ${As(24, t)})`,
          "--pct": t.h / o * 100 + "%"
        });
        o = r ? 1 : 100;
      }
  ...
  `;
    ...
    paintHSL(t, e = null) {
      ...
      const {
        ...
        d = s / 100,
        p = n ? (t, e, i) => `hsl(${t}, ${e}%, ${100 - i}%)` : (t, e, i) => $s.fromHsv({
          h: t,
          s: e,
          v: 100 - i
        }).hex,
  ...
  const Os = t => isFinite(t) ? Number(t) : Number(t.replace(/[^0-9.\-]/g, "")),
    Ls = t => (t = Number(t), (isNaN(t) || [void 0, null].includes(t)) && (t = 0), t);
  class Us {
    constructor(t, e) {
      this.x = Ls(t), this.y = Ls(e);
    }
  ...
  class js extends ut {
    ...
    set color(t) {
      (t = t.hsx ? t : t.rgba ? $s.parse(...t.rgba) : $s.parse(t)) && (this.hex = t.hex, this._color = t, Ps(this.renderRoot, t, "colorchanged"));
    }
    updateColor({
      detail: {
        color: t
  ...
  let Ys = class extends ut {
    constructor() {
      super(...arguments), this.box_id = 0, this.spoolList = [], this.spool_index = -1, this._isOpen = !1, this._changingSlot = !1, this._colourPresetChange = t => {
        ...
        const e = t;
        e.stopPropagation(), e.detail.modalOpen && (this._isOpen = !0, this.box_id = Number(e.detail.box_id), this.spool_index = Number(e.detail.spool_index), this.material_type = fi(e.detail.material_type), this.color = e.detail.color);
    ...
    willUpdate(t) {
      super.willUpdate(t), t.has("language") && (this._heading = Jr("card.spool_settings.heading", this.language), this._labelSelectMaterial = Jr("card.spool_settings.label_select_material", this.language), this._labelSelectColour = Jr("card.spool_settings.label_select_colour", this.language), this._buttonSave = Jr("common.actions.save", this.language));
    }
    update(t) {
      super.update(t), this._isOpen ? this.style.display = "block" : this.style.display = "none";
    }
    ...
    _renderPresets() {
      ...
      <div>
        ...
        <div class="ac-mcb-presets">
          ${this.slotColors ? Bn(this.slotColors, (t, e) => q`
                  <div
  ...
  n([xt("color-picker")], Ys.prototype, "_elColorPicker", void 0), n([yt()], Ys.prototype, "hass", void 0), n([yt()], Ys.prototype, "language", void 0), n([yt({
    attribute: "selected-printer-device"
  })], Ys.prototype, "selectedPrinterDevice", void 0), n([yt({
    attribute: "slot-colors"
  })], Ys.prototype, "slotColors", void 0), n([_t()], Ys.prototype, "box_id", void 0), n([_t()], Ys.prototype, "spoolList", void 0), n([_t()], Ys.prototype, "spool_index", void 0), n([_t()], Ys.prototype, "material_type", void 0), n([_t()], Ys.prototype, "color", void 0), n([_t()], Ys.prototype, "_isOpen", void 0), n([_t()], Ys.prototype, "_heading", void 0), n([_t()], Ys.prototype, "_labelSelectMaterial", void 0), n([_t()], Ys.prototype, "_labelSelectColour", void 0), n([_t()], Ys.prototype, "_buttonSave", void 0), n([_t()], Ys.prototype, "_changingSlot", void 0), Ys = n([In("anycubic-printercard-multicolorbox_modal_spool")], Ys);
  const Ws = {
    keyframeOptions: {
      duration: 250,
      direction: "alternate",
  ...
  let Xs = class extends ut {
    constructor() {
      super(...arguments), this.availableSpeedModes = {}, this.isFDM = !1, this.currentSpeedModeKey = 0, this.currentSpeedModeDescr = void 0, this._userEditSpeedMode = !1, this.currentFanSpeed = 0, this._userEditFanSpeed = !1, this.currentAuxFanSpeed = 0, this._userEditAuxFanSpeed = !1, this.currentBoxFanSpeed = 0, this._userEditBoxFanSpeed = !1, this.currentTargetTempNozzle = 0, this.minTargetTempNozzle = 0, this.maxTargetTempNozzle = 0, this._userEditTargetTempNozzle = !1, this.currentTargetTempHotbed = 0, this.minTargetTempHotbed = 0, this.maxTargetTempHotbed = 0, this._userEditTargetTempHotbed = !1, this._isOpen = !1, this._changingSettings = !1, this._setConfirmationMode = t => {
        this._confirmationType = t.currentTarget.confirmation_type, this._confirmMessage = Jr("card.print_settings.confirm_message", this.language, "action", Jr("common.actions." + this._confirmationType, this.language));
    ...
    willUpdate(t) {
      if (super.willUpdate(t), t.has("language") && (this._labelNozzleTemperature = Jr("card.print_settings.label_nozzle_temp", this.language), this._labelHotbedTemperature = Jr("card.print_settings.label_hotbed_temp", this.language), this._labelFanSpeed = Jr("card.print_settings.label_fan_speed", this.language), this._labelAuxFanSpeed = Jr("card.print_settings.label_aux_fan_speed", this.language), this._labelBoxFanSpeed = Jr("card.print_settings.label_box_fan_speed", this.language), this._buttonYes = Jr("common.actions.yes", this.language), this._buttonNo = Jr("common.actions.no", this.language), this._buttonPrintPause = Jr("card.print_settings.print_pause", this.language), this._buttonPrintResume = Jr("card.print_settings.print_resume", this.language), this._buttonPrintCancel = Jr("card.print_settings.print_cancel", this.language), this._buttonSaveSpeedMode = Jr("card.print_settings.save_speed_mode", this.language), this._buttonSaveTargetNozzle = Jr("card.print_settings.save_target_nozzle", this.language), this._buttonSaveTargetHotbed = Jr("card.print_settings.save_target_hotbed", this.language), this._buttonSaveFanSpeed = Jr("card.print_settings.save_fan_speed", this.language), this._buttonSaveAuxFanSpeed = Jr("card.print_settings.save_aux_fan_speed", this.language), this._buttonSaveBoxFanSpeed = Jr("card.print_settings.save_box_fan_speed", this.language)), t.has("hass") || t.has("printerEntities") || t.has("printerEntityIdPart")) {
        if (this.isFDM = li(this.hass, this.printerEntities, this.printerEntityIdPart), this._userEditFanSpeed || (this.currentFanSpeed = Number(ni(this.hass, this.printerEntities, this.printerEntityIdPart, "fan_speed", 0).state)), !this._userEditTargetTempNozzle) {
          const t = ni(this.hass, this.printerEntities, this.printerEntityIdPart, "target_nozzle_temperature", 0, {
            limit_min: 0,
            limit_max: 0
          });
        ...
        if (!this._userEditTargetTempHotbed) {
          const t = ni(this.hass, this.printerEntities, this.printerEntityIdPart, "target_hotbed_temperature", 0, {
            limit_min: 0,
            limit_max: 0
          });
        ...
        if (!this._userEditSpeedMode) {
          ...
          this.availableSpeedModes = _i(t), this.currentSpeedModeKey = t.attributes.print_speed_mode_code, this.currentSpeedModeDescr = this.currentSpeedModeKey >= 0 && this.currentSpeedModeKey in this.availableSpeedModes ? this.availableSpeedModes[this.currentSpeedModeKey] : void 0;
        }
      }
    }
    update(t) {
  ...
  n([yt()], Xs.prototype, "hass", void 0), n([yt()], Xs.prototype, "language", void 0), n([yt({
    attribute: "selected-printer-device"
  })], Xs.prototype, "selectedPrinterDevice", void 0), n([yt({
    attribute: "printer-entities"
  })], Xs.prototype, "printerEntities", void 0), n([yt({
    attribute: "printer-entity-id-part"
  })], Xs.prototype, "printerEntityIdPart", void 0), n([_t()], Xs.prototype, "availableSpeedModes", void 0), n([_t()], Xs.prototype, "isFDM", void 0), n([_t()], Xs.prototype, "currentSpeedModeKey", void 0), n([_t()], Xs.prototype, "currentSpeedModeDescr", void 0), n([_t()], Xs.prototype, "_userEditSpeedMode", void 0), n([_t()], Xs.prototype, "currentFanSpeed", void 0), n([_t()], Xs.prototype, "_userEditFanSpeed", void 0), n([_t()], Xs.prototype, "currentAuxFanSpeed", void 0), n([_t()], Xs.prototype, "_userEditAuxFanSpeed", void 0), n([_t()], Xs.prototype, "currentBoxFanSpeed", void 0), n([_t()], Xs.prototype, "_userEditBoxFanSpeed", void 0), n([_t()], Xs.prototype, "currentTargetTempNozzle", void 0), n([_t()], Xs.prototype, "minTargetTempNozzle", void 0), n([_t()], Xs.prototype, "maxTargetTempNozzle", void 0), n([_t()], Xs.prototype, "_userEditTargetTempNozzle", void 0), n([_t()], Xs.prototype, "currentTargetTempHotbed", void 0), n([_t()], Xs.prototype, "minTargetTempHotbed", void 0), n([_t()], Xs.prototype, "maxTargetTempHotbed", void 0), n([_t()], Xs.prototype, "_userEditTargetTempHotbed", void 0), n([_t()], Xs.prototype, "_confirmationType", void 0), n([_t()], Xs.prototype, "_isOpen", void 0), n([_t()], Xs.prototype, "_confirmMessage", void 0), n([_t()], Xs.prototype, "_labelNozzleTemperature", void 0), n([_t()], Xs.prototype, "_labelHotbedTemperature", void 0), n([_t()], Xs.prototype, "_labelFanSpeed", void 0), n([_t()], Xs.prototype, "_labelAuxFanSpeed", void 0), n([_t()], Xs.prototype, "_labelBoxFanSpeed", void 0), n([_t()], Xs.prototype, "_buttonYes", void 0), n([_t()], Xs.prototype, "_buttonNo", void 0), n([_t()], Xs.prototype, "_buttonPrintPause", void 0), n([_t()], Xs.prototype, "_buttonPrintResume", void 0), n([_t()], Xs.prototype, "_buttonPrintCancel", void 0), n([_t()], Xs.prototype, "_buttonSaveSpeedMode", void 0), n([_t()], Xs.prototype, "_buttonSaveTargetNozzle", void 0), n([_t()], Xs.prototype, "_buttonSaveTargetHotbed", void 0), n([_t()], Xs.prototype, "_buttonSaveFanSpeed", void 0), n([_t()], Xs.prototype, "_buttonSaveAuxFanSpeed", void 0), n([_t()], Xs.prototype, "_buttonSaveBoxFanSpeed", void 0), n([_t()], Xs.prototype, "_changingSettings", void 0), Xs = n([In("anycubic-printercard-printsettings_modal")], Xs);
  const qs = {
      keyframeOptions: {
        duration: 250,
        direction: "normal",
  ...
  let Zs = class extends ut {
    constructor() {
      super(...arguments), this.monitoredStats = Ks, this.round = !0, this.temperatureUnit = ke.C, this._showVideo = !1, this.cameraEntityState = void 0, this.isHidden = !1, this.isPrinting = !1, this.hiddenOverride = !1, this.hasColorbox = !1, this.hasSecondaryColorbox = !1, this.lightIsOn = !1, this.statusColor = "#ffc107", this.progressPercent = 0, this._togglingLight = !1, this._togglingPower = !1, this._toggleVideo = () => {
    ...
    willUpdate(t) {
      var e, i, r, n;
      if (super.willUpdate(t), t.has("language") && (this._buttonPrintSettings = Jr("card.buttons.print_settings", this.language)), t.has("monitoredStats") && (this.monitoredStats = (r = this.monitoredStats, n = Ks, void 0 === r ? n : r)), t.has("selectedPrinterID") && (this.printerEntities = Ke(this.hass, this.selectedPrinterID), this.printerEntityIdPart = ti(this.printerEntities)), t.has("hass") || t.has("alwaysShow") || t.has("hiddenOverride") || t.has("selectedPrinterID")) {
        this.progressPercent = this._percentComplete(), this.hasColorbox = "active" === ni(this.hass, this.printerEntities, this.printerEntityIdPart, "ace_spools", "inactive").state, this.hasSecondaryColorbox = "active" === ni(this.hass, this.printerEntities, this.printerEntityIdPart, "secondary_multi_color_box_spools", "inactive").state, this.cameraEntityId && (this.cameraEntityState = We(this.hass, {
          entity_id: this.cameraEntityId
        })), this.lightIsOn = qe(this.hass, {
          entity_id: null !== (e = this.lightEntityId) && void 0 !== e ? e : ""
        }, !0, !1);
        const t = ni(this.hass, this.printerEntities, this.printerEntityIdPart, "job_state", "unknown").state.toLowerCase();
        this.isPrinting = di(t), this.isHidden = !this.alwaysShow && !this.hiddenOverride && !this.isPrinting, this.statusColor = function (t) {
          return "preheating" === t ? "#ffc107" : di(t) ? "#4caf50" : "unknown" === t ? "#f44336" : "operational" === t || "finished" === t ? "#00bcd4" : "#f44336";
        }(t), this.lightIsOn = qe(this.hass, {
    ...
    _renderHeader() {
      ...
      return q`
      <div class="ac-printer-card-header ${sn(e)}">
    ...
    _renderPrinterContainer() {
      ...
      return q`
      <div
        class="ac-printer-card-infocontainer ${sn(t)}"
        style=${ln(e)}
        ${kn(Object.assign({}, qs))}
      >
        <div
          class="ac-printer-card-info-animcontainer ${sn(t)}"
          style=${ln(i)}
        >
        ...
        <div
          class="ac-printer-card-info-statscontainer ${sn(t)}"
          style=${ln(r)}
        >
    ...
    _renderPrintSettingsContainer() {
      ...
      return this.showSettingsButton || this.isPrinting ? q`
          ...
          >
            <div
              class="ac-printer-card-settingssection ${sn(t)}"
            >
              <button
    ...
    _renderMultiColorBoxContainer() {
      ...
      return this.hasColorbox ? q`
          <div
            ...
            ${kn(Object.assign({}, qs))}
          >
            <div class="ac-printer-card-mcbsection ${sn(t)}">
    ...
    _percentComplete() {
      const t = Number(ni(this.hass, this.printerEntities, this.printerEntityIdPart, "job_progress", -1).state);
  ...
  n([xt(".ac-printer-card")], Zs.prototype, "_printerCardContainer", void 0), n([yt()], Zs.prototype, "hass", void 0), n([yt()], Zs.prototype, "language", void 0), n([yt({
    attribute: "monitored-stats"
  })], Zs.prototype, "monitoredStats", void 0), n([yt({
    attribute: "selected-printer-id"
  })], Zs.prototype, "selectedPrinterID", void 0), n([yt({
    attribute: "selected-printer-device"
  })], Zs.prototype, "selectedPrinterDevice", void 0), n([yt({
    type: Boolean
  })], Zs.prototype, "round", void 0), n([yt({
    type: Boolean
  })], Zs.prototype, "use_24hr", void 0), n([yt({
    attribute: "show-settings-button",
    type: Boolean
  })], Zs.prototype, "showSettingsButton", void 0), n([yt({
    attribute: "always-show",
    type: Boolean
  })], Zs.prototype, "alwaysShow", void 0), n([yt({
    attribute: "temperature-unit",
    type: String
  })], Zs.prototype, "temperatureUnit", void 0), n([yt({
    attribute: "light-entity-id",
    type: String
  })], Zs.prototype, "lightEntityId", void 0), n([yt({
    attribute: "power-entity-id",
    type: String
  })], Zs.prototype, "powerEntityId", void 0), n([yt({
    attribute: "camera-entity-id",
    type: String
  })], Zs.prototype, "cameraEntityId", void 0), n([yt({
    type: Boolean
  })], Zs.prototype, "vertical", void 0), n([yt({
    attribute: "scale-factor"
  })], Zs.prototype, "scaleFactor", void 0), n([yt({
    attribute: "slot-colors"
  })], Zs.prototype, "slotColors", void 0), n([_t()], Zs.prototype, "_showVideo", void 0), n([_t()], Zs.prototype, "cameraEntityState", void 0), n([_t()], Zs.prototype, "isHidden", void 0), n([_t()], Zs.prototype, "isPrinting", void 0), n([_t()], Zs.prototype, "hiddenOverride", void 0), n([_t()], Zs.prototype, "hasColorbox", void 0), n([_t()], Zs.prototype, "hasSecondaryColorbox", void 0), n([_t()], Zs.prototype, "lightIsOn", void 0), n([_t()], Zs.prototype, "statusColor", void 0), n([_t()], Zs.prototype, "printerEntities", void 0), n([_t()], Zs.prototype, "printerEntityIdPart", void 0), n([_t()], Zs.prototype, "progressPercent", void 0), n([_t()], Zs.prototype, "_buttonPrintSettings", void 0), n([_t()], Zs.prototype, "_togglingLight", void 0), n([_t()], Zs.prototype, "_togglingPower", void 0), Zs = n([In("anycubic-printercard-card")], Zs);
  const Qs = [...yi(), Oe.DryingStatus, Oe.DryingTime],
    Js = [...vi(), Oe.PrinterOnline, Oe.Availability, Oe.ProjectName, Oe.CurrentLayer],
    to = yi(),
  ...
  let io = class extends ut {
    constructor() {
      super(...arguments), this.isFDM = !1, this.monitoredStats = Js;
    }
    willUpdate(t) {
      var e;
      if (super.willUpdate(t), t.has("language") && (this._statTranslations = eo.reduce((t, e) => (t[e] = Jr(`panels.main.cards.main.fields.${e}`, this.language), t), {})), t.has("selectedPrinterDevice") && (this.printerID = (e = this.selectedPrinterDevice) ? e.serial_number : void 0, this.printerMAC = function (t) {
        return t && t.connections.length > 0 && t.connections[0].length > 1 ? t.connections[0][1] : null;
      }(this.selectedPrinterDevice)), t.has("selectedPrinterID") && (this.printerEntities = Ke(this.hass, this.selectedPrinterID), this.printerEntityIdPart = ti(this.printerEntities)), t.has("hass") || t.has("selectedPrinterID")) {
        this.isFDM = li(this.hass, this.printerEntities, this.printerEntityIdPart), this.printerStateFwUpdateAvailable = ai(this.hass, this.printerEntities, this.printerEntityIdPart, "printer_firmware"), this.printerStateAvailable = oi(this.hass, this.printerEntities, this.printerEntityIdPart, "is_available", "Available", "Busy"), this.printerStateOnline = oi(this.hass, this.printerEntities, this.printerEntityIdPart, "printer_online", "Online", "Offline"), this.printerStateCurrNozzleTemp = si(this.hass, this.printerEntities, this.printerEntityIdPart, "nozzle_temperature"), this.printerStateCurrHotbedTemp = si(this.hass, this.printerEntities, this.printerEntityIdPart, "hotbed_temperature"), this.printerStateTargetNozzleTemp = si(this.hass, this.printerEntities, this.printerEntityIdPart, "target_nozzle_temperature"), this.printerStateTargetHotbedTemp = si(this.hass, this.printerEntities, this.printerEntityIdPart, "target_hotbed_temperature");
        const t = si(this.hass, this.printerEntities, this.printerEntityIdPart, "job_progress");
        this.jobStateProgress = void 0 !== t ? `${t}%` : "0%", this.jobStatePrintState = function (t, e, i, r, n = !1) {
          const s = Je(e, i, "sensor", r);
          if (s) {
            const e = Xe(t, s);
            return n ? Ye(e) : e;
          }
        }(this.hass, this.printerEntities, this.printerEntityIdPart, "job_state", !0), this.aceStateFwUpdateAvailable = ai(this.hass, this.printerEntities, this.printerEntityIdPart, "ace_firmware"), this.aceStateDryingActive = oi(this.hass, this.printerEntities, this.printerEntityIdPart, "drying_active", "Drying", "Not Drying"), this.aceStateDryingRemaining = si(this.hass, this.printerEntities, this.printerEntityIdPart, "drying_remaining_time"), this.aceStateDryingTotal = si(this.hass, this.printerEntities, this.printerEntityIdPart, "drying_total_duration"), this.aceDryingProgress = void 0 !== this.aceStateDryingRemaining && void 0 !== this.aceStateDryingTotal ? String((this.aceStateDryingTotal > 0 ? Math.round(1e4 * (1 - this.aceStateDryingRemaining / this.aceStateDryingTotal)) / 100 : 0).toFixed(2)) + "%" : void 0, this.aceStateFwUpdateAvailable ? this.monitoredStats = Qs : this.isFDM ? this.monitoredStats = to : this.monitoredStats = Js;
      }
    }
    _renderInfoRow(t, e) {
      return q`
    ...
    _resolvedCameraEntityId() {
      var t;
      const e = this.selectedPrinterID ? null === (t = this.panel.config.cameraEntityIds) || void 0 === t ? void 0 : t[this.selectedPrinterID] : void 0;
      return null != e ? e : this.panel.config.cameraEntityId;
    }
    render() {
      var t, e, i, r, n;
      return q`
  ...
  n([yt()], io.prototype, "hass", void 0), n([yt()], io.prototype, "language", void 0), n([yt({
    ...
    attribute: "selected-printer-device"
  })], io.prototype, "selectedPrinterDevice", void 0), n([_t()], io.prototype, "printerEntities", void 0), n([_t()], io.prototype, "printerEntityIdPart", void 0), n([_t()], io.prototype, "printerID", void 0), n([_t()], io.prototype, "printerMAC", void 0), n([_t()], io.prototype, "printerStateFwUpdateAvailable", void 0), n([_t()], io.prototype, "printerStateAvailable", void 0), n([_t()], io.prototype, "printerStateOnline", void 0), n([_t()], io.prototype, "printerStateCurrNozzleTemp", void 0), n([_t()], io.prototype, "printerStateCurrHotbedTemp", void 0), n([_t()], io.prototype, "printerStateTargetNozzleTemp", void 0), n([_t()], io.prototype, "printerStateTargetHotbedTemp", void 0), n([_t()], io.prototype, "jobStateProgress", void 0), n([_t()], io.prototype, "jobStatePrintState", void 0), n([_t()], io.prototype, "aceStateFwUpdateAvailable", void 0), n([_t()], io.prototype, "aceStateDryingActive", void 0), n([_t()], io.prototype, "aceStateDryingRemaining", void 0), n([_t()], io.prototype, "aceStateDryingTotal", void 0), n([_t()], io.prototype, "aceDryingProgress", void 0), n([_t()], io.prototype, "isFDM", void 0), n([_t()], io.prototype, "monitoredStats", void 0), n([_t()], io.prototype, "_statTranslations", void 0), io = n([bt("anycubic-view-main")], io);
  const ro = p`
  :host {
    padding: 16px;
    display: block;
...
`;
  class no extends ut {
    ...
    willUpdate(t) {
      super.willUpdate(t), t.has("language") && (this._noMqttMessage = Jr("common.messages.mqtt_unsupported", this.language)), (t.has("hass") || t.has("selectedPrinterID")) && (this.printerEntities = Ke(this.hass, this.selectedPrinterID), this.printerEntityIdPart = ti(this.printerEntities), this._supportsMQTT = function (t, e, i) {
        const r = We(t, Je(e, i, "binary_sensor", "mqtt_connection_active"));
  ...
  n([yt()], no.prototype, "hass", void 0), n([yt()], no.prototype, "language", void 0), n([yt({
    type: Boolean,
    reflect: !0
  })], no.prototype, "narrow", void 0), n([yt()], no.prototype, "route", void 0), n([yt()], no.prototype, "panel", void 0), n([yt({
    attribute: "selected-printer-id"
  })], no.prototype, "selectedPrinterID", void 0), n([yt({
    attribute: "selected-printer-device"
  })], no.prototype, "selectedPrinterDevice", void 0), n([_t()], no.prototype, "printerEntities", void 0), n([_t()], no.prototype, "printerEntityIdPart", void 0), n([_t()], no.prototype, "_fileArray", void 0), n([_t()], no.prototype, "_listRefreshEntity", void 0), n([_t()], no.prototype, "_isRefreshing", void 0), n([_t()], no.prototype, "_isDeleting", void 0), n([_t()], no.prototype, "_noMqttMessage", void 0), n([_t()], no.prototype, "_supportsMQTT", void 0), n([_t()], no.prototype, "_httpResponse", void 0);
  let so = class extends no {
    constructor() {
      super(...arguments), this._httpResponse = !0, this.deleteFile = t => {
        const e = t.currentTarget.file_info;
        this.selectedPrinterDevice && e.id && (this._isDeleting = !0, this.hass.callService(Gs, "delete_file_cloud", {
          config_entry: this.selectedPrinterDevice.primary_config_entry,
          device_id: this.selectedPrinterDevice.id,
          file_id: e.id
        }).then(() => {
    ...
    willUpdate(t) {
      if (super.willUpdate(t), t.has("hass") || t.has("selectedPrinterID")) {
        const t = We(this.hass, Ze(this.printerEntities, "sensor", "file_list_cloud"));
        this._fileArray = t ? t.attributes.file_info : void 0, this._listRefreshEntity = function (t) {
          return Ze(t, "button", "request_file_list_cloud");
        }(this.printerEntities);
      }
    }
  };
  n([_t()], so.prototype, "_fileArray", void 0), n([_t()], so.prototype, "_httpResponse", void 0), so = n([bt("anycubic-view-files_cloud")], so);
  let oo = class extends no {
    constructor() {
      super(...arguments), this.deleteFile = t => {
        const e = t.currentTarget.file_info;
        this.selectedPrinterDevice && e.name && (this._isDeleting = !0, this.hass.callService(Gs, "delete_file_local", {
          config_entry: this.selectedPrinterDevice.primary_config_entry,
          device_id: this.selectedPrinterDevice.id,
          filename: e.name
        }).then(() => {
    ...
    willUpdate(t) {
      if (super.willUpdate(t), t.has("hass") || t.has("selectedPrinterID")) {
        const t = We(this.hass, Ze(this.printerEntities, "sensor", "file_list_local"));
        this._fileArray = t ? t.attributes.file_info : void 0, this._listRefreshEntity = function (t) {
          return Ze(t, "button", "request_file_list_local");
        }(this.printerEntities);
      }
    }
  };
  oo = n([bt("anycubic-view-files_local")], oo);
  let ao = class extends no {
    constructor() {
      super(...arguments), this.deleteFile = t => {
        const e = t.currentTarget.file_info;
        this.selectedPrinterDevice && e.name && (this._isDeleting = !0, this.hass.callService(Gs, "delete_file_udisk", {
          config_entry: this.selectedPrinterDevice.primary_config_entry,
          device_id: this.selectedPrinterDevice.id,
          filename: e.name
        }).then(() => {
    ...
    willUpdate(t) {
      if (super.willUpdate(t), t.has("hass") || t.has("selectedPrinterID")) {
        const t = We(this.hass, Ze(this.printerEntities, "sensor", "file_list_udisk"));
        this._fileArray = t ? t.attributes.file_info : void 0, this._listRefreshEntity = function (t) {
          return Ze(t, "button", "request_file_list_udisk");
        }(this.printerEntities);
      }
    }
  };
  ao = n([bt("anycubic-view-files_udisk")], ao);
  const lo = p`
  :host {
    padding: 16px;
    display: block;
...
`;
  ...
  class co extends ut {
    constructor() {
      super(...arguments), this._scriptData = {}, this._serviceName = "", this._buttonProgress = !1, this._scriptDataChanged = t => {
        ...
        })(), this.hass.callService(Gs, this._serviceName, this._scriptData.data).then(() => {
    ...
    willUpdate(t) {
      if (super.willUpdate(t), t.has("language") && (this._buttonPrint = Jr("common.actions.print", this.language)), t.has("selectedPrinterDevice") && this.selectedPrinterDevice) {
        const t = `${Gs}.${this._serviceName}`;
  ...
  n([yt({
    attribute: !1
  })], co.prototype, "hass", void 0), n([yt()], co.prototype, "language", void 0), n([yt({
    type: Boolean,
    reflect: !0
  })], co.prototype, "narrow", void 0), n([yt()], co.prototype, "route", void 0), n([yt()], co.prototype, "panel", void 0), n([yt({
    attribute: "selected-printer-id"
  })], co.prototype, "selectedPrinterID", void 0), n([yt({
    attribute: "selected-printer-device"
  })], co.prototype, "selectedPrinterDevice", void 0), n([_t()], co.prototype, "_scriptData", void 0), n([_t()], co.prototype, "_error", void 0), n([_t()], co.prototype, "_serviceName", void 0), n([_t()], co.prototype, "_buttonPrint", void 0), n([_t()], co.prototype, "_buttonProgress", void 0);
  let po = class extends co {
    constructor() {
      super(...arguments), this._serviceName = "print_and_upload_no_cloud_save";
    }
  };
  n([_t()], po.prototype, "_serviceName", void 0), po = n([bt("anycubic-view-print-no_cloud_save")], po);
  let uo = class extends co {
    constructor() {
      super(...arguments), this._serviceName = "print_and_upload_save_in_cloud";
    }
  };
  n([_t()], uo.prototype, "_serviceName", void 0), uo = n([bt("anycubic-view-print-save_in_cloud")], uo);
  var go = "0.0.61";
  window.console.info(`%c ANYCUBIC-PANEL %c v${go} `, "color: orange; font-weight: bold; background: black", "color: white; font-weight: bold; background: dimgray"), t.AnycubicCloudPanel = class extends ut {
    constructor() {
    ...
    willUpdate(t) {
      var e, i;
      super.willUpdate(t), t.has("hass") && this.hass.language !== this.language && (this.language = this.hass.language, this._tabMain = Jr("panels.main.title", this.language), this._tabFilesLocal = Jr("panels.files_local.title", this.language), this._tabFilesUdisk = Jr("panels.files_udisk.title", this.language), this._tabFilesCloud = Jr("panels.files_cloud.title", this.language), this._tabPrintNoSave = Jr("panels.print_no_cloud_save.title", this.language), this._tabPrintSave = Jr("panels.print_save_in_cloud.title", this.language), this._tabDebug = Jr("panels.debug.title", this.language), this._mainTitle = Jr("title", this.language), this._selectPrinter = Jr("panels.initial.printer_select", this.language)), t.has("route") && (this.printers = function (t) {
        const e = {};
        ...
        return e;
      }(this.hass), this.selectedPage = ci(this.route), this.selectedPrinterID = hi(this.route), this.selectedPrinterDevice = (e = this.printers, i = this.selectedPrinterID, e && i ? e[i] : void 0));
    }
    render() {
