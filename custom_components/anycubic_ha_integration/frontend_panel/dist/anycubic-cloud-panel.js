!function (t) {
  ...
  const ue = {
    ...
    fe = {
      ...
      B: function (t, e, i) {
        const r = t.getHours();
        let n;
        switch (n = r >= 17 ? ye : r >= 12 ? ve : r >= 4 ? be : _e, e) {
          case "B":
          case "BB":
          case "BBB":
            return i.dayPeriod(n, {
  ...
  function Be(t, e, i) {
    ...
    return l.map(r => {
      ...
      return (0, fe[s[0]])(a, s, n.localize, h);
    }).join("");
  }
  function Ie(t) {
    const e = t.match(Me);
  ...
  const Ve = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, Le), ze), Re), je), Ge);
  var Ye, We;
  !function (t) {
  ...
  function ni(t, e, i) {
    for (const r in t) {
      const n = t[r];
      if (r.split(".")[0] === e && Ke(n, i)) return n;
    }
    for (const r in t) {
      const n = t[r],
        s = r.split("."),
  ...
  function oi(t, e, i, r) {
    for (const e in t) {
      const n = t[e];
      if (e.split(".")[0] === i && Ke(n, r)) return n;
    }
  ...
  function li(t, e, i, r) {
    return function (t, e, i, r, n = "unavailable", s = {}) {
      return ti(t, oi(e, i, "button", r)) || Qe({
        state: String(n),
        attributes: s
      });
    }(t, e, i, r, "unavailable", {
  ...
  function di(t, e, i, r, n = "unavailable", s = {}) {
    return ti(t, oi(e, i, "sensor", r)) || Qe({
      state: String(n),
      attributes: s
    });
  }
  ...
  function ui(t, e, i, r, n, s, o = void 0) {
    ...
    return a ? ii(t, a, n, s) : o;
  }
  function gi(t, e, i, r) {
    const n = oi(e, i, "update", r);
    return n ? ii(t, n, "Update Available", "Up To Date") : void 0;
  }
  function mi(t, e, i) {
  ...
  const xi = {
    ...
    Ei = (t, e, i = !1) => {
      const r = parseFloat(t.state),
        ...
        s = (o = r, l = e || n, xi[a = n] && xi[a][l] ? xi[a][l](o) : -1);
      var o, a, l;
  ...
  function $i() {
    return [...Si(), Ve.HotendCurrent, Ve.BedCurrent, Ve.HotendTarget, Ve.BedTarget, Ve.PrinterOnline, Ve.Availability, Ve.ProjectName, Ve.CurrentLayer];
  }
  function Pi(t) {
    var e;
  ...
  let Ti = class extends ut {
    willUpdate(t) {
      super.willUpdate(t), t.has("selectedPrinterID") && (this.printerEntities = ri(this.hass, this.selectedPrinterID));
    }
    render() {
      return q`
  ...
  n([yt()], Ti.prototype, "hass", void 0), n([yt()], Ti.prototype, "language", void 0), n([yt({
    type: Boolean,
    reflect: !0
  })], Ti.prototype, "narrow", void 0), n([yt()], Ti.prototype, "route", void 0), n([yt()], Ti.prototype, "panel", void 0), n([yt()], Ti.prototype, "printers", void 0), n([yt({
    attribute: "selected-printer-id"
  })], Ti.prototype, "selectedPrinterID", void 0), n([yt({
    attribute: "selected-printer-device"
  })], Ti.prototype, "selectedPrinterDevice", void 0), n([_t()], Ti.prototype, "printerEntities", void 0), Ti = n([mt("anycubic-view-debug")], Ti);
  var Ci,
    Hi,
    Di,
    Mi = "Anycubic Cloud",
  ...
  function Rr(t, e) {
    return zr(t, this, 1 === t.length ? Lr : Ur, e.cache.create(), e.serializer);
  }
  var jr = function () {
  ...
  var Vr,
    ...
    Wr = {
      ...
      monadic: function (t, e) {
        return zr(t, this, Lr, e.cache.create(), e.serializer);
      }
    };
  !function (t) {
  ...
  function tn(t, e, i, r, n, s, o) {
    ...
    for (var a = [], l = 0, h = t; l < h.length; l++) {
      ...
      if (Oi(c)) a.push({
        ...
        var p = n[d];
        if (Li(c)) p && "string" != typeof p && "number" != typeof p || (p = "string" == typeof p || "number" == typeof p ? String(p) : ""), a.push({
  ...
  const Un = cn(class extends Tn {
      ...
      update(t, [e]) {
        ...
        return i && (this.u = t.options?.host, this.u.addController(this), this.u.updateComplete.then(t => this.t = !0), this.element = t.element, Ln.set(this.element, this)), this.optionsOrCallback = e, (i || "function" != typeof e) && this.p(e), this.render(e);
      }
      p(t) {
        t = t ?? {};
        ...
        void 0 !== e && ((t = {
          ...
          ...t.keyframeOptions
        }), t.properties ??= On, this.options = t;
      }
      m() {
        const t = {},
    ...
    zn = t => e => "function" == typeof e ? ((t, e) => (window.customElements.get(t) || window.customElements.define(t, e), e))(t, e) : ((t, e) => {
      const {
        kind: i,
        elements: r
      } = e;
  ...
  })], Rn.prototype, "showVideo", void 0), n([yt({
    attribute: "toggle-video"
  })], Rn.prototype, "toggleVideo", void 0), n([yt({
    attribute: "camera-entity"
  })], Rn.prototype, "cameraEntity", void 0), n([_t()], Rn.prototype, "camImgString", void 0), Rn = n([zn("anycubic-printercard-camera_view")], Rn);
  const Gn = "secondary_",
    Vn = "ace_run_out_refill",
    Yn = Gn + Vn,
    Wn = "ace_spools",
    Xn = Gn + Wn;
  let qn = class extends ut {
    constructor() {
      super(...arguments), this.box_id = 0, this._runoutRefillId = Vn, this._spoolsEntityId = Wn, this.spoolList = [], this.selectedIndex = -1, this.selectedMaterialType = "", this.selectedColor = [0, 0, 0], this._changingRunout = !1, this._openDryingModal = () => {
    ...
    willUpdate(t) {
      var e, i, r, n;
      super.willUpdate(t), t.has("language") && (this._buttonRefill = an("card.buttons.runout_refill", this.language), this._buttonDry = an("card.buttons.dry", this.language)), t.has("box_id") && (1 === this.box_id ? (this._runoutRefillId = Yn, this._spoolsEntityId = Xn) : (this._runoutRefillId = Vn, this._spoolsEntityId = Wn)), (t.has("hass") || t.has("printerEntities") || t.has("printerEntityIdPart")) && (this.spoolList = di(this.hass, this.printerEntities, this.printerEntityIdPart, this._spoolsEntityId, "not loaded", {
        spool_info: []
      }).attributes.spool_info, this._runoutRefillState = (e = this.hass, i = this.printerEntities, r = this.printerEntityIdPart, n = this._runoutRefillId, ti(e, oi(i, r, "switch", n))));
    }
    render() {
      return q`
  ...
  n([yt()], qn.prototype, "hass", void 0), n([yt()], qn.prototype, "language", void 0), n([yt({
    attribute: "printer-entities"
  })], qn.prototype, "printerEntities", void 0), n([yt({
    attribute: "printer-entity-id-part"
  })], qn.prototype, "printerEntityIdPart", void 0), n([yt()], qn.prototype, "box_id", void 0), n([_t()], qn.prototype, "_runoutRefillId", void 0), n([_t()], qn.prototype, "_spoolsEntityId", void 0), n([_t()], qn.prototype, "spoolList", void 0), n([_t()], qn.prototype, "selectedIndex", void 0), n([_t()], qn.prototype, "selectedMaterialType", void 0), n([_t()], qn.prototype, "selectedColor", void 0), n([_t()], qn.prototype, "_runoutRefillState", void 0), n([_t()], qn.prototype, "_buttonRefill", void 0), n([_t()], qn.prototype, "_buttonDry", void 0), n([_t()], qn.prototype, "_changingRunout", void 0), qn = n([zn("anycubic-printercard-multicolorbox_view")], qn);
  class Kn {
    constructor(t) {
      this.scale_factor = t;
    }
  ...
  let es = class extends ut {
    constructor() {
      super(...arguments), this._progressNum = 0, this.animKeyframeGantry = 0, this._isPrinting = !1, this._gantryAnimOptions = () => Object.assign(Object.assign({}, Jn), {
    ...
    willUpdate(t) {
      if (super.willUpdate(t), t.has("scaleFactor") && this._onResizeEvent(), t.has("hass") || t.has("printerEntities") || t.has("printerEntityIdPart")) {
        ...
        this.imagePreviewUrl !== t && (this.imagePreviewUrl = t, this.imagePreviewBgUrl = this.imagePreviewUrl ? `url('${t}')` : void 0), this._progressNum = Number(di(this.hass, this.printerEntities, this.printerEntityIdPart, "job_progress", 0).state) / 100;
        const e = yi(di(this.hass, this.printerEntities, this.printerEntityIdPart, "job_state").state.toLowerCase());
  ...
  n([wt(".ac-printercard-animatedprinter")], es.prototype, "_rootElement", void 0), n([wt(".ac-apr-scalable")], es.prototype, "_elAcAPr_scalable", void 0), n([wt(".ac-apr-frame")], es.prototype, "_elAcAPr_frame", void 0), n([wt(".ac-apr-hole")], es.prototype, "_elAcAPr_hole", void 0), n([wt(".ac-apr-buildarea")], es.prototype, "_elAcAPr_buildarea", void 0), n([wt(".ac-apr-animprint")], es.prototype, "_elAcAPr_animprint", void 0), n([wt(".ac-apr-buildplate")], es.prototype, "_elAcAPr_buildplate", void 0), n([wt(".ac-apr-xaxis")], es.prototype, "_elAcAPr_xaxis", void 0), n([wt(".ac-apr-gantry")], es.prototype, "_elAcAPr_gantry", void 0), n([wt(".ac-apr-nozzle")], es.prototype, "_elAcAPr_nozzle", void 0), n([yt()], es.prototype, "hass", void 0), n([yt({
    attribute: "scale-factor"
  })], es.prototype, "scaleFactor", void 0), n([yt({
    attribute: "printer-config"
  })], es.prototype, "printerConfig", void 0), n([yt({
    attribute: "printer-entities"
  })], es.prototype, "printerEntities", void 0), n([yt({
    attribute: "printer-entity-id-part"
  })], es.prototype, "printerEntityIdPart", void 0), n([_t()], es.prototype, "dimensions", void 0), n([_t()], es.prototype, "resizeObserver", void 0), n([_t()], es.prototype, "_progressNum", void 0), n([_t()], es.prototype, "animKeyframeGantry", void 0), n([_t()], es.prototype, "_isPrinting", void 0), n([_t()], es.prototype, "imagePreviewUrl", void 0), n([_t()], es.prototype, "imagePreviewBgUrl", void 0), es = n([zn("anycubic-printercard-animated_printer")], es);
  ...
  n([yt()], is.prototype, "hass", void 0), n([yt({
    attribute: "toggle-video",
    type: Function
  })], is.prototype, "toggleVideo", void 0), n([yt({
    attribute: "printer-entities"
  })], is.prototype, "printerEntities", void 0), n([yt({
    attribute: "printer-entity-id-part"
  })], is.prototype, "printerEntityIdPart", void 0), n([yt({
    attribute: "scale-factor"
  })], is.prototype, "scaleFactor", void 0), is = n([zn("anycubic-printercard-printer_view")], is);
  /**
       * @license
       * Copyright 2017 Google LLC
       * SPDX-License-Identifier: BSD-3-Clause
    ...
    ns = cn(class extends dn {
      ...
      update(t, [e, i, r]) {
        ...
        let h,
          ...
          u = 0,
          g = s.length - 1;
        for (; d <= p && u <= g;) if (null === n[d]) d++;else if (null === n[p]) p--;else if (a[d] === o[u]) l[u] = _n(n[d], s[u]), d++, u++;else if (a[p] === o[g]) l[g] = _n(n[p], s[g]), p--, g--;else if (a[d] === o[g]) l[g] = _n(n[d], s[g]), yn(t, l[g + 1], n[d]), d++, g--;else if (a[p] === o[u]) l[u] = _n(n[p], s[u]), yn(t, n[d], n[p]), p--, u++;else if (void 0 === h && (h = rs(o, u, g), c = rs(a, d, p)), h.has(a[d])) {
          if (h.has(a[p])) {
            const e = c.get(o[u]),
              i = void 0 !== e ? n[e] : null;
            if (null === i) {
  ...
  n([yt({
    ...
    type: Number
  })], ss.prototype, "progress", void 0), ss = n([zn("anycubic-printercard-progress-line")], ss);
  ...
  n([yt({
    ...
    type: String
  })], os.prototype, "value", void 0), n([yt({
    type: String
  })], os.prototype, "unit", void 0), os = n([zn("anycubic-printercard-stat-line")], os);
  let as = class extends ut {
    render() {
      return q`<anycubic-printercard-stat-line
      .name=${this.name}
      .value=${Ei(this.temperatureEntity, this.temperatureUnit, this.round)}
  ...
  })], as.prototype, "temperatureEntity", void 0), n([yt({
    type: Boolean
  })], as.prototype, "round", void 0), n([yt({
    attribute: "temperature-unit",
    type: String
  })], as.prototype, "temperatureUnit", void 0), as = n([zn("anycubic-printercard-stat-temperature")], as);
  ...
  n([yt({
    ...
    type: Boolean
  })], ls.prototype, "isSeconds", void 0), n([_t()], ls.prototype, "currentTime", void 0), n([_t()], ls.prototype, "lastIntervalId", void 0), ls = n([zn("anycubic-printercard-stat-time")], ls);
...
`;
  ...
  n([yt()], ds.prototype, "item", void 0), n([_t()], ds.prototype, "_isActive", void 0), ds = n([zn("anycubic-ui-select-dropdown-item")], ds);
  let ps = class extends ut {
    ...
    _renderOptions() {
      return jn(Object.keys(this.availableOptions), (t, e) => q`
  ...
  })], ps.prototype, "availableOptions", void 0), n([yt()], ps.prototype, "placeholder", void 0), n([yt({
    attribute: "initial-item"
  })], ps.prototype, "initialItem", void 0), n([_t()], ps.prototype, "_selectedItem", void 0), n([_t()], ps.prototype, "_active", void 0), n([_t()], ps.prototype, "_hidden", void 0), ps = n([zn("anycubic-ui-select-dropdown")], ps);
  const us = {
      keyframeOptions: {
        duration: 250,
        direction: "alternate",
  ...
  let $s = class extends ut {
    constructor() {
      super(...arguments), this.box_id = 0, this._dryingPresetId1 = gs, this._dryingPresetId2 = ms, this._dryingPresetId3 = bs, this._dryingPresetId4 = vs, this._dryingStopId = ys, this._hasDryingPreset1 = !1, this._hasDryingPreset2 = !1, this._hasDryingPreset3 = !1, this._hasDryingPreset4 = !1, this._hasDryingStop = !1, this._dryingPresetTemp1 = "", this._dryingPresetDur1 = "", this._dryingPresetTemp2 = "", this._dryingPresetDur2 = "", this._dryingPresetTemp3 = "", this._dryingPresetDur3 = "", this._dryingPresetTemp4 = "", this._dryingPresetDur4 = "", this._isOpen = !1, this._handleDryingPreset1 = () => {
    ...
    willUpdate(t) {
      if (super.willUpdate(t), t.has("language") && (this._heading = an("card.drying_settings.heading", this.language), this._buttonTextPreset = an("card.drying_settings.button_preset", this.language), this._buttonTextMinutes = an("card.drying_settings.button_minutes", this.language), this._buttonStopDrying = an("card.drying_settings.button_stop_drying", this.language)), t.has("box_id") && (1 === this.box_id ? (this._dryingPresetId1 = fs, this._dryingPresetId2 = ws, this._dryingPresetId3 = xs, this._dryingPresetId4 = Es, this._dryingStopId = Ss) : (this._dryingPresetId1 = gs, this._dryingPresetId2 = ms, this._dryingPresetId3 = bs, this._dryingPresetId4 = vs, this._dryingStopId = ys)), t.has("hass") || t.has("selectedPrinterDevice")) {
  ...
  n([yt()], $s.prototype, "hass", void 0), n([yt()], $s.prototype, "language", void 0), n([yt({
    attribute: "selected-printer-device"
  })], $s.prototype, "selectedPrinterDevice", void 0), n([yt({
    attribute: "printer-entities"
  })], $s.prototype, "printerEntities", void 0), n([yt({
    attribute: "printer-entity-id-part"
  })], $s.prototype, "printerEntityIdPart", void 0), n([_t()], $s.prototype, "box_id", void 0), n([_t()], $s.prototype, "_dryingPresetId1", void 0), n([_t()], $s.prototype, "_dryingPresetId2", void 0), n([_t()], $s.prototype, "_dryingPresetId3", void 0), n([_t()], $s.prototype, "_dryingPresetId4", void 0), n([_t()], $s.prototype, "_dryingStopId", void 0), n([_t()], $s.prototype, "_hasDryingPreset1", void 0), n([_t()], $s.prototype, "_hasDryingPreset2", void 0), n([_t()], $s.prototype, "_hasDryingPreset3", void 0), n([_t()], $s.prototype, "_hasDryingPreset4", void 0), n([_t()], $s.prototype, "_hasDryingStop", void 0), n([_t()], $s.prototype, "_dryingPresetTemp1", void 0), n([_t()], $s.prototype, "_dryingPresetDur1", void 0), n([_t()], $s.prototype, "_dryingPresetTemp2", void 0), n([_t()], $s.prototype, "_dryingPresetDur2", void 0), n([_t()], $s.prototype, "_dryingPresetTemp3", void 0), n([_t()], $s.prototype, "_dryingPresetDur3", void 0), n([_t()], $s.prototype, "_dryingPresetTemp4", void 0), n([_t()], $s.prototype, "_dryingPresetDur4", void 0), n([_t()], $s.prototype, "_isOpen", void 0), n([_t()], $s.prototype, "_heading", void 0), n([_t()], $s.prototype, "_buttonTextPreset", void 0), n([_t()], $s.prototype, "_buttonTextMinutes", void 0), n([_t()], $s.prototype, "_buttonStopDrying", void 0), $s = n([zn("anycubic-printercard-multicolorbox_modal_drying")], $s);
  ...
  class Ms {
    constructor(t, e, i, r) {
      return Ms.isBaseConstructor(t) ? (this.r = Ps(t.r), this.g = Ps(t.g), this.b = Ps(t.b), void 0 !== t.a && (this.a = Hs(t.a)), this) : Ms.parse(t, e, i, r);
    }
    static parse(t, e, i, r) {
      if (Ms.isBaseConstructor(t)) return new Ms(t);
      if (void 0 !== e && void 0 !== i) {
        let n = Ps(t);
        return e = Ps(e), i = Ps(i), void 0 !== r && (r = Hs(r)), new Ms({
          r: n,
          g: e,
          b: i,
          a: r
      ...
      if ("string" == typeof t) {
        ...
        if (Ds[t.toLowerCase()]) return Ms.fromNamed(t, i);
      ...
      if ("object" == typeof t) {
        if (void 0 !== t.a && (this.a = Hs(t.a)), void 0 !== t.h) {
          ...
          return e.a = void 0 !== t.a ? Hs(t.a) : void 0, new Ms(e);
        }
    ...
    static fromNamed(t, e) {
      return Ms.fromHex(Ds[t.toLowerCase()], e);
    }
    static fromArray(t) {
      ...
      return void 0 !== t[3] && (e.a = Hs(t[3])), new Ms(e);
    }
    static fromHex(t, e) {
    ...
    static fromHsl({
      ...
      let o = 0,
        a = 0,
        l = 0;
      return 0 <= t && t < 60 ? (o = r, a = n, l = 0) : 60 <= t && t < 120 ? (o = n, a = r, l = 0) : 120 <= t && t < 180 ? (o = 0, a = r, l = n) : 180 <= t && t < 240 ? (o = 0, a = n, l = r) : 240 <= t && t < 300 ? (o = n, a = 0, l = r) : 300 <= t && t < 360 && (o = r, a = 0, l = n), new Ms({
        r: As(s + o),
        g: As(s + a),
        b: As(s + l)
      });
    ...
    mix(t, e = .5) {
      ...
      return n[3] = Ts(n[3]), Ms.fromArray(n);
    }
    adjustSatLum(t, e, i) {
      const r = this.hsl;
      let n = r[t],
        s = (i ? n : 100 - n) * e;
      return r[t] = Cs(100, i ? n - s : n + s), r.a = this.a, new Ms(r);
    }
    lighten(t, e = !1) {
...
`,
  ...
  `;
    ...
    paintHSL(t, e = null) {
      ...
      const {
        ...
        d = s / 100,
        p = n ? (t, e, i) => `hsl(${t}, ${e}%, ${100 - i}%)` : (t, e, i) => Ms.fromHsv({
          h: t,
          s: e,
          v: 100 - i
        }).hex,
  ...
  class qs extends ut {
    ...
    set boundsX(t) {
      this._boundsX = Xs.fromString(t, Vs(this.target?.style.left ?? 0)), this.bounds.left = this._boundsX;
    }
    get boundsY() {
      return this._boundsY;
    }
    set boundsY(t) {
      this._boundsY = Xs.fromString(t, Vs(this.target?.style.top ?? 0)), this.bounds.top = this._boundsY;
    }
    static properties = {
      posLeft: {
        type: Number
  ...
  window.customElements.get("lit-movable") || window.customElements.define("lit-movable", qs);
  class Ks extends ut {
    static properties = {
      color: {
        type: Object,
    ...
    _color;
    constructor() {
      super(), this._color = Ms.parse(Ds.slateblue), this.isHsl = !0, this.buttonDisabled = !1;
    }
    firstUpdated(t) {
  ...
  let Js = class extends ut {
    constructor() {
      super(...arguments), this.box_id = 0, this.spoolList = [], this.spool_index = -1, this._isOpen = !1, this._changingSlot = !1, this._colourPresetChange = t => {
        ...
        const e = t;
        e.stopPropagation(), e.detail.modalOpen && (this._isOpen = !0, this.box_id = Number(e.detail.box_id), this.spool_index = Number(e.detail.spool_index), this.material_type = Ai(e.detail.material_type), this.color = e.detail.color);
      }, this._handleDropdownEvent = t => {
        const e = t;
        e.stopPropagation(), e.detail.value && (this.material_type = Ai(e.detail.value));
    ...
    _renderPresets() {
      ...
      <div>
        ...
        <div class="ac-mcb-presets">
          ${this.slotColors ? jn(this.slotColors, (t, e) => q`
                  <div
  ...
  n([wt("color-picker")], Js.prototype, "_elColorPicker", void 0), n([yt()], Js.prototype, "hass", void 0), n([yt()], Js.prototype, "language", void 0), n([yt({
    attribute: "selected-printer-device"
  })], Js.prototype, "selectedPrinterDevice", void 0), n([yt({
    attribute: "slot-colors"
  })], Js.prototype, "slotColors", void 0), n([_t()], Js.prototype, "box_id", void 0), n([_t()], Js.prototype, "spoolList", void 0), n([_t()], Js.prototype, "spool_index", void 0), n([_t()], Js.prototype, "material_type", void 0), n([_t()], Js.prototype, "color", void 0), n([_t()], Js.prototype, "_isOpen", void 0), n([_t()], Js.prototype, "_heading", void 0), n([_t()], Js.prototype, "_labelSelectMaterial", void 0), n([_t()], Js.prototype, "_labelSelectColour", void 0), n([_t()], Js.prototype, "_buttonSave", void 0), n([_t()], Js.prototype, "_changingSlot", void 0), Js = n([zn("anycubic-printercard-multicolorbox_modal_spool")], Js);
  const to = {
    keyframeOptions: {
      duration: 250,
      direction: "alternate",
  ...
  n([yt()], eo.prototype, "hass", void 0), n([yt()], eo.prototype, "language", void 0), n([yt({
    attribute: "selected-printer-device"
  })], eo.prototype, "selectedPrinterDevice", void 0), n([yt({
    attribute: "printer-entities"
  })], eo.prototype, "printerEntities", void 0), n([yt({
    attribute: "printer-entity-id-part"
  })], eo.prototype, "printerEntityIdPart", void 0), n([_t()], eo.prototype, "availableSpeedModes", void 0), n([_t()], eo.prototype, "isFDM", void 0), n([_t()], eo.prototype, "currentSpeedModeKey", void 0), n([_t()], eo.prototype, "currentSpeedModeDescr", void 0), n([_t()], eo.prototype, "_userEditSpeedMode", void 0), n([_t()], eo.prototype, "currentFanSpeed", void 0), n([_t()], eo.prototype, "_userEditFanSpeed", void 0), n([_t()], eo.prototype, "currentAuxFanSpeed", void 0), n([_t()], eo.prototype, "_userEditAuxFanSpeed", void 0), n([_t()], eo.prototype, "currentBoxFanSpeed", void 0), n([_t()], eo.prototype, "_userEditBoxFanSpeed", void 0), n([_t()], eo.prototype, "currentTargetTempNozzle", void 0), n([_t()], eo.prototype, "minTargetTempNozzle", void 0), n([_t()], eo.prototype, "maxTargetTempNozzle", void 0), n([_t()], eo.prototype, "_userEditTargetTempNozzle", void 0), n([_t()], eo.prototype, "currentTargetTempHotbed", void 0), n([_t()], eo.prototype, "minTargetTempHotbed", void 0), n([_t()], eo.prototype, "maxTargetTempHotbed", void 0), n([_t()], eo.prototype, "_userEditTargetTempHotbed", void 0), n([_t()], eo.prototype, "_confirmationType", void 0), n([_t()], eo.prototype, "_isOpen", void 0), n([_t()], eo.prototype, "_confirmMessage", void 0), n([_t()], eo.prototype, "_labelNozzleTemperature", void 0), n([_t()], eo.prototype, "_labelHotbedTemperature", void 0), n([_t()], eo.prototype, "_labelFanSpeed", void 0), n([_t()], eo.prototype, "_labelAuxFanSpeed", void 0), n([_t()], eo.prototype, "_labelBoxFanSpeed", void 0), n([_t()], eo.prototype, "_buttonYes", void 0), n([_t()], eo.prototype, "_buttonNo", void 0), n([_t()], eo.prototype, "_buttonPrintPause", void 0), n([_t()], eo.prototype, "_buttonPrintResume", void 0), n([_t()], eo.prototype, "_buttonPrintCancel", void 0), n([_t()], eo.prototype, "_buttonSaveSpeedMode", void 0), n([_t()], eo.prototype, "_buttonSaveTargetNozzle", void 0), n([_t()], eo.prototype, "_buttonSaveTargetHotbed", void 0), n([_t()], eo.prototype, "_buttonSaveFanSpeed", void 0), n([_t()], eo.prototype, "_buttonSaveAuxFanSpeed", void 0), n([_t()], eo.prototype, "_buttonSaveBoxFanSpeed", void 0), n([_t()], eo.prototype, "_changingSettings", void 0), eo = n([zn("anycubic-printercard-printsettings_modal")], eo);
  const io = {
      keyframeOptions: {
        duration: 250,
        direction: "normal",
  ...
  let no = class extends ut {
    constructor() {
      super(...arguments), this.monitoredStats = ro, this.round = !0, this.temperatureUnit = Ue.C, this._showVideo = !1, this.cameraEntityState = void 0, this.isHidden = !1, this.isPrinting = !1, this.hiddenOverride = !1, this.hasColorbox = !1, this.hasSecondaryColorbox = !1, this.lightIsOn = !1, this.statusColor = "#ffc107", this.progressPercent = 0, this._togglingLight = !1, this._togglingPower = !1, this._toggleVideo = () => {
    ...
    willUpdate(t) {
      ...
      if (super.willUpdate(t), t.has("language") && (this._buttonPrintSettings = an("card.buttons.print_settings", this.language)), t.has("monitoredStats") && (this.monitoredStats = (r = this.monitoredStats, n = ro, void 0 === r ? n : r)), t.has("selectedPrinterID") && (this.printerEntities = ri(this.hass, this.selectedPrinterID), this.printerEntityIdPart = ai(this.printerEntities)), t.has("hass") || t.has("alwaysShow") || t.has("hiddenOverride") || t.has("selectedPrinterID")) {
        ...
        this.isPrinting = yi(t), this.isHidden = !this.alwaysShow && !this.hiddenOverride && !this.isPrinting, this.statusColor = function (t) {
          return "preheating" === t ? "#ffc107" : yi(t) ? "#4caf50" : "unknown" === t ? "#f44336" : "operational" === t || "finished" === t ? "#00bcd4" : "#f44336";
        }(t), this.lightIsOn = ii(this.hass, {
  ...
  n([wt(".ac-printer-card")], no.prototype, "_printerCardContainer", void 0), n([yt()], no.prototype, "hass", void 0), n([yt()], no.prototype, "language", void 0), n([yt({
    attribute: "monitored-stats"
  })], no.prototype, "monitoredStats", void 0), n([yt({
    attribute: "selected-printer-id"
  })], no.prototype, "selectedPrinterID", void 0), n([yt({
    attribute: "selected-printer-device"
  })], no.prototype, "selectedPrinterDevice", void 0), n([yt({
    type: Boolean
  })], no.prototype, "round", void 0), n([yt({
    type: Boolean
  })], no.prototype, "use_24hr", void 0), n([yt({
    attribute: "show-settings-button",
    type: Boolean
  })], no.prototype, "showSettingsButton", void 0), n([yt({
    attribute: "always-show",
    type: Boolean
  })], no.prototype, "alwaysShow", void 0), n([yt({
    attribute: "temperature-unit",
    type: String
  })], no.prototype, "temperatureUnit", void 0), n([yt({
    attribute: "light-entity-id",
    type: String
  })], no.prototype, "lightEntityId", void 0), n([yt({
    attribute: "power-entity-id",
    type: String
  })], no.prototype, "powerEntityId", void 0), n([yt({
    attribute: "camera-entity-id",
    type: String
  })], no.prototype, "cameraEntityId", void 0), n([yt({
    type: Boolean
  })], no.prototype, "vertical", void 0), n([yt({
    attribute: "scale-factor"
  })], no.prototype, "scaleFactor", void 0), n([yt({
    attribute: "slot-colors"
  })], no.prototype, "slotColors", void 0), n([_t()], no.prototype, "_showVideo", void 0), n([_t()], no.prototype, "cameraEntityState", void 0), n([_t()], no.prototype, "isHidden", void 0), n([_t()], no.prototype, "isPrinting", void 0), n([_t()], no.prototype, "hiddenOverride", void 0), n([_t()], no.prototype, "hasColorbox", void 0), n([_t()], no.prototype, "hasSecondaryColorbox", void 0), n([_t()], no.prototype, "lightIsOn", void 0), n([_t()], no.prototype, "statusColor", void 0), n([_t()], no.prototype, "printerEntities", void 0), n([_t()], no.prototype, "printerEntityIdPart", void 0), n([_t()], no.prototype, "progressPercent", void 0), n([_t()], no.prototype, "_buttonPrintSettings", void 0), n([_t()], no.prototype, "_togglingLight", void 0), n([_t()], no.prototype, "_togglingPower", void 0), no = n([zn("anycubic-printercard-card")], no);
  const so = [...$i(), Ve.DryingStatus, Ve.DryingTime],
    oo = [...Si(), Ve.PrinterOnline, Ve.Availability, Ve.ProjectName, Ve.CurrentLayer],
    ao = $i(),
    lo = ["printer_name", "printer_id", "printer_mac", "printer_model", "printer_fw_version", "printer_fw_update_available", "printer_online", "printer_available", "curr_nozzle_temp", "curr_hotbed_temp", "target_nozzle_temp", "target_hotbed_temp", "job_state", "job_progress", "ace_fw_version", "ace_fw_update_available", "drying_active", "drying_progress"];
  let ho = class extends ut {
    constructor() {
      super(...arguments), this.isFDM = !1, this.monitoredStats = oo;
    }
    willUpdate(t) {
      var e;
      if (super.willUpdate(t), t.has("language") && (this._statTranslations = lo.reduce((t, e) => (t[e] = an(`panels.main.cards.main.fields.${e}`, this.language), t), {})), t.has("selectedPrinterDevice") && (this.printerID = (e = this.selectedPrinterDevice) ? e.serial_number : void 0, this.printerMAC = function (t) {
        return t && t.connections.length > 0 && t.connections[0].length > 1 ? t.connections[0][1] : null;
      }(this.selectedPrinterDevice)), t.has("selectedPrinterID") && (this.printerEntities = ri(this.hass, this.selectedPrinterID), this.printerEntityIdPart = ai(this.printerEntities)), t.has("hass") || t.has("selectedPrinterID")) {
  ...
  n([yt()], ho.prototype, "hass", void 0), n([yt()], ho.prototype, "language", void 0), n([yt({
    ...
    attribute: "selected-printer-device"
  })], ho.prototype, "selectedPrinterDevice", void 0), n([_t()], ho.prototype, "printerEntities", void 0), n([_t()], ho.prototype, "printerEntityIdPart", void 0), n([_t()], ho.prototype, "printerID", void 0), n([_t()], ho.prototype, "printerMAC", void 0), n([_t()], ho.prototype, "printerStateFwUpdateAvailable", void 0), n([_t()], ho.prototype, "printerStateAvailable", void 0), n([_t()], ho.prototype, "printerStateOnline", void 0), n([_t()], ho.prototype, "printerStateCurrNozzleTemp", void 0), n([_t()], ho.prototype, "printerStateCurrHotbedTemp", void 0), n([_t()], ho.prototype, "printerStateTargetNozzleTemp", void 0), n([_t()], ho.prototype, "printerStateTargetHotbedTemp", void 0), n([_t()], ho.prototype, "jobStateProgress", void 0), n([_t()], ho.prototype, "jobStatePrintState", void 0), n([_t()], ho.prototype, "aceStateFwUpdateAvailable", void 0), n([_t()], ho.prototype, "aceStateDryingActive", void 0), n([_t()], ho.prototype, "aceStateDryingRemaining", void 0), n([_t()], ho.prototype, "aceStateDryingTotal", void 0), n([_t()], ho.prototype, "aceDryingProgress", void 0), n([_t()], ho.prototype, "isFDM", void 0), n([_t()], ho.prototype, "monitoredStats", void 0), n([_t()], ho.prototype, "_statTranslations", void 0), ho = n([mt("anycubic-view-main")], ho);
  const co = p`
  :host {
    padding: 16px;
    display: block;
...
`;
  class po extends ut {
    ...
    willUpdate(t) {
      super.willUpdate(t), t.has("language") && (this._noMqttMessage = an("common.messages.mqtt_unsupported", this.language)), (t.has("hass") || t.has("selectedPrinterID")) && (this.printerEntities = ri(this.hass, this.selectedPrinterID), this.printerEntityIdPart = ai(this.printerEntities), this._supportsMQTT = function (t, e, i) {
        const r = ti(t, oi(e, i, "binary_sensor", "mqtt_connection_active"));
  ...
  n([yt()], po.prototype, "hass", void 0), n([yt()], po.prototype, "language", void 0), n([yt({
    ...
    attribute: "selected-printer-device"
  })], po.prototype, "selectedPrinterDevice", void 0), n([_t()], po.prototype, "printerEntities", void 0), n([_t()], po.prototype, "printerEntityIdPart", void 0), n([_t()], po.prototype, "_fileArray", void 0), n([_t()], po.prototype, "_listRefreshEntity", void 0), n([_t()], po.prototype, "_isRefreshing", void 0), n([_t()], po.prototype, "_isDeleting", void 0), n([_t()], po.prototype, "_noMqttMessage", void 0), n([_t()], po.prototype, "_supportsMQTT", void 0), n([_t()], po.prototype, "_httpResponse", void 0);
  let uo = class extends po {
    constructor() {
    ...
    willUpdate(t) {
      if (super.willUpdate(t), t.has("hass") || t.has("selectedPrinterID")) {
        const t = ti(this.hass, ni(this.printerEntities, "sensor", "file_list_cloud"));
  ...
  n([_t()], uo.prototype, "_fileArray", void 0), n([_t()], uo.prototype, "_httpResponse", void 0), uo = n([mt("anycubic-view-files_cloud")], uo);
  let go = class extends po {
    ...
    willUpdate(t) {
      if (super.willUpdate(t), t.has("hass") || t.has("selectedPrinterID")) {
        const t = ti(this.hass, ni(this.printerEntities, "sensor", "file_list_local"));
        this._fileArray = t ? t.attributes.file_info : void 0, this._listRefreshEntity = function (t) {
  ...
  go = n([mt("anycubic-view-files_local")], go);
  let mo = class extends po {
    ...
    willUpdate(t) {
      if (super.willUpdate(t), t.has("hass") || t.has("selectedPrinterID")) {
        const t = ti(this.hass, ni(this.printerEntities, "sensor", "file_list_udisk"));
        this._fileArray = t ? t.attributes.file_info : void 0, this._listRefreshEntity = function (t) {
  ...
  mo = n([mt("anycubic-view-files_udisk")], mo);
  const bo = p`
  :host {
    padding: 16px;
    display: block;
...
`;
  ...
  class yo extends ut {
    constructor() {
      super(...arguments), this._scriptData = {}, this._serviceName = "", this._buttonProgress = !1, this._scriptDataChanged = t => {
        ...
        this._error = void 0, t.stopPropagation(), this._buttonProgress = !0, ((t = vo.Medium) => {
  ...
  n([yt({
    attribute: !1
  })], yo.prototype, "hass", void 0), n([yt()], yo.prototype, "language", void 0), n([yt({
    type: Boolean,
    reflect: !0
  })], yo.prototype, "narrow", void 0), n([yt()], yo.prototype, "route", void 0), n([yt()], yo.prototype, "panel", void 0), n([yt({
    attribute: "selected-printer-id"
  })], yo.prototype, "selectedPrinterID", void 0), n([yt({
    attribute: "selected-printer-device"
  })], yo.prototype, "selectedPrinterDevice", void 0), n([_t()], yo.prototype, "_scriptData", void 0), n([_t()], yo.prototype, "_error", void 0), n([_t()], yo.prototype, "_serviceName", void 0), n([_t()], yo.prototype, "_buttonPrint", void 0), n([_t()], yo.prototype, "_buttonProgress", void 0);
  let _o = class extends yo {
    constructor() {
      super(...arguments), this._serviceName = "print_and_upload_no_cloud_save";
    }
  };
  n([_t()], _o.prototype, "_serviceName", void 0), _o = n([mt("anycubic-view-print-no_cloud_save")], _o);
  let fo = class extends yo {
    constructor() {
      super(...arguments), this._serviceName = "print_and_upload_save_in_cloud";
    }
  };
  n([_t()], fo.prototype, "_serviceName", void 0), fo = n([mt("anycubic-view-print-save_in_cloud")], fo);
  var wo = "0.0.61";
  window.console.info(`%c ANYCUBIC-PANEL %c v${wo} `, "color: orange; font-weight: bold; background: black", "color: white; font-weight: bold; background: dimgray"), t.AnycubicCloudPanel = class extends ut {
    constructor() {
      super(...arguments), this.selectedPage = "main", this._handleLocationChange = () => {
        ...
        ((t, e, i = !1) => {
          ...
          i ? history.replaceState(null, "", r) : history.pushState(null, "", r), Oe(window, "location-changed", {
            replace: i
          });
        ...
        e !== vi(this.route) ? (((t, e, i = !1) => {
          const r = t.route.prefix,
            n = bi(t.route),
            s = `${r}/${n ? `${n}/${e}` : ""}`;
          i ? history.replaceState(null, "", s) : history.pushState(null, "", s), Oe(window, "location-changed", {
            replace: i
          });
